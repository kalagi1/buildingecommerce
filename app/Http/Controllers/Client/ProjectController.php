    ...
    public function index($slug, $id, Request $request)
    {
        ...
        if ($project) {
            ...
            for ($i = 1; $i <= $room_counts; $i++) {
                ...
                if (!$has_share_sale && !empty($total_quantity->total_quantity) && isset($total_quantity) && !$has_same_quantity || $has_share_sale && !empty($total_quantity->total_quantity) && isset($total_quantity) && $has_same_quantity) {
