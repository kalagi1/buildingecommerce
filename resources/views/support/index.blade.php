                    ...
                    <div class="row justify-content-center align-items-center" style="margin:-top:70px;margin-bottom:60px;">
                        <div class="col-md-12 ">
                            <div id="kategori1Content" class="accordion-content">
                                ...
                                <form action="{{route('support.sendSupportMessage')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-7 mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label" style="font-size: 12px !important;">Kategori</label>
                                    ...
                                    <div class="col-md-7 mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label" style="font-size: 12px !important;">Açıklama</label>
                        ...
                        <p style="float: left;margin-left: -330px;margin-top: 22px;color:hsl(0, 1%, 38%) !important">Kişisel verilerin korunması hakkında detaylı bilgiye <a href="" id="kvkkLink">buradan</a> ulaşabilirsiniz.</p>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/plug-ins/1.10.24/i18n/Turkish.json"></script>
    <script>
