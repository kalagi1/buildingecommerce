        ...
        <div class="p-2 rounded-lg bg-yellow-100">
            <div class="flex items-center justify-between flex-wrap">
                ...
                <div class="mt-2 flex-shrink-0 w-full sm:mt-0 flex justify-end gap-2 d-flex justify-content-end">
                    <button
                        class="js-cookie-consent-agree cookie-consent__agree cursor-pointer ml-2 flex items-center justify-center px-4 py-2 rounded-md text-sm font-medium text-yellow-800 bg-yellow-400 hover:bg-yellow-300">
                        {{ trans('cookie-consent::texts.agree') }}
                    </button>
                    <button style="color: black;"
                        class="js-cookie-consent-decline cookie-consent__decline cursor-pointer ml-2 flex items-center justify-center px-4 py-2 rounded-md text-sm font-medium text-red-800 bg-red-400 hover:bg-red-300">
