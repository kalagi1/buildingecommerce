...
<div id="cookie-management-modal"
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-11/12 max-w-lg">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button id="close-modal" class="px-4 py-2 bg-gray-300 hover:bg-gray-400 text-sm font-medium rounded-md border-none"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
        </div>
