        ...
        <div class="listing-item compact" style="height:100%">
            ...
            'id' => $project->id+1000000]) }}" class="listing-img-container">
                <span class="project_brand_profile_image">
                    <img loading="lazy" src="{{ URL::to('/') . '/storage/profile_images/' . $project->user->profile_image }}" alt="">
                ...
                <img loading="lazy" src="{{ URL::to('/') . '/' . str_replace('public/', 'storage/', $project->image) }}" alt="" style="height:100%;object-fit:cover">
            </a>
        </div>
    </div>
</div>
