                                ...
                                @if ($sold_check && $sold->status == '1')
                                    ...
                                    @else
                                        <button class="first-btn payment-plan-button"
                                            ...
                                            data-sold="{{ ($sold && ($sold->status != 2) && $share_sale == "[]") || (isset($sumCartOrderQt[$keyIndex]) && $sumCartOrderQt[$keyIndex]['qt_total'] == $number_of_share) || ( !$sold && isset($projectHousingsList[$keyIndex]['off_sale']) && $projectHousingsList[$keyIndex]['off_sale'] != '[]') ? '1' : '0' }}"
