                    ...
                    <div class="homes">
                                ...
                                align-items: center;">
                                            ...
                                            @if (isset($sold) && $sold->status == '1')
                                                @php
                                                    ...
                                                    if (Auth::check()) {
                                                        $neighborView = App\Models\NeighborView::where(
                                                            'user_id',
                                                            Auth::user()->id,
                                                        )
                        ...
                        data-bs-target="#neighborViewModal{{ $sold->id }}" data-order="{{ $sold->id }}" @endif>
                                                ...
                                                @elseif($neighborView && $neighborView->status == '0')
                                                    <button
                                                        class="btn payment-plan-button payment-plan-mobile-btn mobileCBtn"
                                                        style="width:50% !important">
                                                        <span> <svg viewBox="0 0 24 24" width="10" height="10"
                                                ...
                                                @if (isset($projectHousingsList[$keyIndex]['off_sale']) && $projectHousingsList[$keyIndex]['off_sale'] != '[]')
                                                    @if (Auth::user())
                                                        <button
                                                            ...
                                                            data-toggle="modal"
                                                            data-target="#offerModal{{ $keyIndex }}"
                                                            style="width:50% !important">
                                                            Başvuru Yap
                                                        </button>
                                                    @else
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="offerModal{{ $keyIndex }}" tabindex="-1"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h3 class="modal-title"
                                                style="margin:10px;font-size:12px !important;text-align:center"
                                                id="exampleModalLabel"> {{ $project->project_title }} Projesi
                                                {{ $keyIndex }} No'lu İlan
                                                için
                                                Başvuru Yap</h3>
                                            <hr>
                                            <form method="POST" action="{{ route('give_offer') }}">
                                                ...
                                                <input type="hidden" value="{{ $project->user_id }}"
                                                    name="projectUserId">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="modal-input"
                                                                placeholder="Ad Soyad" id="name" name="name">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="surname" class="q-label">Telefon Numarası :
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="modal-input"
                                                                placeholder="E-Posta" id="email" name="email">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="modal-input"
                                                                placeholder="Meslek" id="title" name="title">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-footer" style="justify-content: end !important">
                                                    <button type="submit" class="btn btn-success"
                                                        style="width:150px">Gönder</button>
                                                    <button type="button" class="btn btn-danger"
                                                        data-dismiss="modal" style="width:150px">Kapat</button>
                                                </div>
                                            </form>
                                            ...
                                            <div class="modal-body">
                                                <div class="invoice">
                                                    <div class="invoice-header mb-3">
                                                        ...
                                                        <span style="color:#e54242;font-weight:700">Tutar: 250
                                                            TL</span>
                                                    ...
                                                    <div class="invoice-body">
                                                        <div class="invoice-total mt-3">
                                                            <div class="mt-3">
                                                                <span><strong style="color:black">Komşumu Gör
                                                                        Özelliği:</strong> Bu özellik,
                                                                    komşunuzun
                                                                    iletişim bilgilerine ulaşabilmeniz için aktif
                                                                    edilmelidir.</span><br>
                                                                <span>Komşunuza ait iletişim bilgilerini görmek için
                                                                    aşağıdaki adımları takip
                                                                    edin:</span>
                                                                <ul>
                                                                    <li><i class="fa fa-circle circleIcon mr-1"
                                                                            style="color: #EA2B2E ;"
                                                                            aria-hidden="true"></i>Ödeme işlemini
                                                                        tamamlayın ve belirtilen
                                                                        tutarı
                                                                        aşağıdaki banka hesaplarından birine havale veya
                                                                        EFT yapın.</li>
                                                                    <li><i class="fa fa-circle circleIcon mr-1"
                                                                            style="color: #EA2B2E ;"
                                                                            aria-hidden="true"></i>Ödemeniz
                                                                        onaylandıktan sonra, "Komşumu Gör"
                                                                        düğmesi
                                                                        aktif olacak ve komşunuzun iletişim bilgilerine
                                                                        ulaşabileceksiniz.</li>
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="ibanInfo" style="font-size: 12px !important">
                                                            </div>
                                                ...
                                                <div class="d-flex">
                                                    <button type="button"
                                                        ...
                                                        id="completePaymentButton{{ $sold->id }}"
                                                        data-order="{{ $sold->id }}"
