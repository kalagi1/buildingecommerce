                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-xs-12">
                        <div class="plan text-center">
                            ...
                            <p class="plan-price"><sup class="currency"></sup><small>{{ $projectTotalCount }} proje bulundu</small><sub></sub></p>
                        ...
                        <div class="plan text-center">
                            ...
                            <ul class="list-unstyled" id="merchantList">
                                ...
                                @foreach ($merchants as $merchant)
                                    ...
                                    <li class="project-item" @if($visibleCount > 3) style="display: none;" @endif>
                                        <a href="{{ url('/magaza/' . strtolower(str_replace(' ', '-', $merchant->name)) . "/" . $merchant['id']) }}">
