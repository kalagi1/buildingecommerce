        ...
        App\Models\Offer::where('type', 'housing')->where('housing_id', $result['id'])->where('start_date', '<=', date('Y-m-d H:i:s'))->where('end_date', '>=', date('Y-m-d H:i:s'))->first()->discount_amount ?? 0
                                    ...
                                    <div class="d-flex" style="flex-wrap: nowrap">
                                        <div class="align-items-center d-flex " style="padding-right:0; width: 110px;">
                                            <div class="project-inner project-head">
                                                <a href="{{ route('housing.show', ['housingSlug' => $result['slug'], 'housingID' => $result['id'] + 2000000]) }}">
                                                    <div class="homes">
                                        ...
                                        <div class="w-100" style="padding-left:0;">
                                            <div class="bg-white px-3 h-100 d-flex flex-column justify-content-center">
                                                ...
                                                <a style="text-decoration: none;height:100%"
                                                    href="{{ route('housing.show', ['housingSlug' => $result['slug'], 'housingID' => $result['id'] + 2000000]) }}">
                                                    <div class="d-flex"
                                                        ...
                                                        @else
                                                            ...
                                                            <script>
                                                                function redirectToReservation() {
                                                                    window.location.href = "{{ route('housing.show', ['housingSlug' => $result['slug'], 'housingID' => $result['id'] + 2000000]) }}";
                                                                }
                                                            </script>
                                                        @endif
                                                    </div>
