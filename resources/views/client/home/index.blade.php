            ...
            <div class="portfolio ">
                ...
                <div class="slick-lancers" style="height: 95px">
                    <div class="agents-grid" data-aos="fade-up" data-aos-delay="150">
                        <a href="http://private.emlaksepette.com/kategori/al-sat-acil" class="homes-img">
        ...
        <section class="popular-places home18 mb-3 mt-3">
            <div class="container">
                <div class="mb-3" style="display: flex; justify-content: space-between; align-items:center">
                    ...
                    <a href="http://private.emlaksepette.com/kategori/tum-projeler" style="font-size: 11px;">
        ...
        <section class="featured portfolio rec-pro disc bg-white mt-5">
            <div class="container">
                <div class="mb-3" style="display: flex; justify-content: space-between; align-items:center">
                    ...
                    <a href="http://private.emlaksepette.com/kategori/emlak-ilanlari" style="font-size: 11px;">
                        <button style="background-color: #ea2a28; color: white; padding: 5px 10px; border: none;"
                            class="w-100">
                            Tümünü Gör
                        </button>
