            ...
            <div class="mobile-show">
                @foreach ($finishProjects as $project)
                    @for ($i = 0; $i < $project->room_count; $i++)
                        ...
                        @php($discount_amount =App\Models\Offer::where('type', 'project')->where('project_id', $project->id)->where('project_housings', 'LIKE', "%\"{$room_order}\"%")->where('start_date', '<=', date('Y-m-d H:i:s'))->where('end_date', '>=', date('Y-m-d H:i:s'))->first()->discount_amount ?? 0)
                                                            ...
                                                            <div class="homes">
                                                                ...
                                                                <div class="homes-img">
                                                                    <div class="homes-tag button sale rent"
                                                                        style="background-color:red!important">Öne
                                                                        Çıkan
                                                                    </div>
                                                ...
                                                <div class="project-single">
                                                    <div class="project-inner project-head">
                                                        <div class="homes">
                                                            ...
                                                            <div class="homes-img">
                                                                <div class="homes-tag button sale rent"
                                                                    style="background-color:red!important">Öne Çıkan
                                                                </div>
                                                                <img src="{{ URL::to('/') . '/housing_images/' . json_decode($project->housing_type_data)->image }}"
                                                    ...
                                                    <div class="homes-content p-3" style="padding:20px !important">
                                                        ...
                                                        <button class="CartBtn"  data-type='housing' data-id='{{ $project->id }}'>
                                                            <span class="IconContainer">
                                                                <img src="{{asset("sc.png")}}" alt="">
