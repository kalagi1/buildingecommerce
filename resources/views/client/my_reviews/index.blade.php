...
@section('content')
<div class="container">
    <div style="padding: 10px;background:ghostwhite;margin-top:10px;margin-left:15px">
        <span style="font-size: 20px;">Değerlendirmelerim</span>
    </div>
        ...
        <div id="commentTable">
            ...
            <div class="project-table-content user-item">
                <ul style="gap: 20px">
                    ...
                    <li style="width: 10%; align-items: flex-start;">
                        @if ($comment->type == 'Emlak')
                            <a href="{{ route('project.housing.detail', ['slug' => $comment->housing->slug]) }}">{{ $comment->housing->id + 2000000 }}</a>
                        @else
