        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-md-6 mt-3 mb-3">             
                        <img src="{{ asset('sat_kirala/sat_kirala.svg') }}" alt="SVG Resim" class="gorsel" width="200%" height="auto">
                    </div>
            </div>
            ...
            <div class="row" style="margin-top:70px; ">
                <div class="card-container mb-5" >    
                    <div class="col-md-4 col-12">
                        <div class="card">
                            <div class="mt-3 mb-3" style="display: flex; align-items: center; justify-content: center;">
                                <img src="{{ asset('sat_kirala/sales_user.svg') }}" alt="SVG Resim" class="gorsel" style="width: 13%; height: auto; ">
                            </div>                   
                            
                            <p class="cardP1">Sat Kirala ile Hızlı Satış</p>
                            <p class="cardP2">Satmak veya kiralamak istediğiniz gayrimenkulünüzün bilgilerini girin. Binlerce profesyonel emlak danışmanı vasıtasıyla hızlı ve kolayca satışını sizin yerinize biz sağlayalım.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="card">
                            <div class="mt-3 mb-3"  style="display: flex; align-items: center; justify-content: center;">             
                                <img src="{{ asset('sat_kirala/security.svg') }}" alt="SVG Resim" class="gorsel" width="13%" height="auto">
                            </div>
                            <p class="cardP1">Kapora Güvence Sistemi</p>
                            <p class="cardP2">Gayrimenkulünüzün satışı tamamlandığı takdirde kapora güvence sistemiyle kaporanız bizim güvencemiz altındadır.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="card">
                            <div class="mt-3 mb-3"  style="display: flex; align-items: center; justify-content: center;">             
                                <img src="{{ asset('sat_kirala/user_fill.svg') }}" alt="SVG Resim" class="gorsel" width="13%" height="auto">
                            </div>
                            <p class="cardP1">Emlaksepette.com Uzmanlğı</p>
                            <p class="cardP2">Emlaksepette.com ile tüm satış veya kiralama süreçlerinde profesyonel ve güvenilir hizmet alırsınız.</p>
                        </div>
                    </div>  
                </div>  
            </div>
                    ...
                    <div class="row mt-5 " style="margin-bottom: 80px;">
                        <div class="card-containerIlan mb-5" >    
                            <div class="col-md-4 col-12"> 
                                ...
                                <div class="mt-3 mb-3">             
                                    <img src="{{ asset('sat_kirala/sağa_ok.svg') }}" alt="SVG Resim" class="gorselSagOk" width="30%" height="auto" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="mt-3 mb-3">             
                                    <img src="{{ asset('sat_kirala/yukari_ok.svg') }}" alt="SVG Resim" class="gorselYukariOk" width="30%" height="auto" >
                                </div>
                            </div>
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="card accordionCard">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body">
                                            Sat kirala sistemi gayrimenkullerini hızlı güvenli ve değerinde satmak isteyen bireysel satıcıların gayrimenkullerin platforma kayıtlı kurumsal emlak firmaları vasıtasıyla satışını sağlayan bir hizmettir.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card accordionCard">
                                    ...
                                    <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="fa-ul">
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Web sitemiz veya mobil uygulamamız üzerinden ilan bilgileri girilir</li>
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Kriterlere uygun ilanlar onaylanır.</li>
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Emlak sepette sistemine dahil olan kurumsal satıcılara ilanınız ulaştırılır.</li>
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Sat Kirala sistemine dahil olan kurumsal satıcılara ulaştırılır.</li>
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Kurumsal satıcımız sizinle temas kurarak gayrimenkulünüzün Fotoğraf çekimleri, değerleme, potansiyel alıcı/müşteri bulma, satış sürecindeki devir ve tüm yasal işlemleri adınıza takip etmektedir. </li>
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Satış süreci olumlu tamamlandığında noter ve devi işlemleri sonrasında satışınız tamamlanmış olur.</li>
                                            </ul>
                                ...
                                <div class="card accordionCard">
                                    ...
                                    <div class="card-body">
                                        İlanınız kurumsal satıcımıza ulaştığında onayınız doğrultusunda minimum 90 gün olmak üzere kurumsal satıcımız ile yapacağınız yetkilendirme sözleşmesi süresi boyunca satış süreçleri tarafımızdan yönetilir. Satış gerçekleşmediği taktirde onayınız doğrultusunda hiçbir bedel ödemeden satış sürecini sonlandırabilirsiniz. 
                                    </div>
                                    </div>
                                </div>
                                </div>
                        ...
                        <div id="kategori2Content" class="accordion-content" style="display: none;">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="card accordionCard">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body">
                                            Web sitemiz yada mobil uygulamamız üzerinden bize ulaştırdığınız gayrimenkulün fiyatını piyasa koşullarına göre serbest bir şekilde siz belirlersiniz. 
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card accordionCard">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body">
                                            Sat Kirala sistemine katılım ücretsizdir. Gayrimenkulünü satmak isteyen kullanıcılarımızdan herhangi bir komisyon veya ücret alınmamaktadır.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="kategori3Content" class="accordion-content" style="display: none;">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="card accordionCard">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body">
                                            Web sitemiz yada mobil uygulamamız üzerinden girdiğiniz ilanınız onaylandıktan sonra binlerce kurumsal mağazamız içerisinden lokasyonunuza en uygun konumdaki kurumsal satıcımız size ulaşıp randevu alacaktır.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card accordionCard">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body">
                                            ...
                                            <ul class="fa-ul">
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Başvuruyu yapan kişinin mutlaka tapu sahibi olması gerekmektedir.</li>
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Gayrimenkul üzerinde satışa engel oluşturacak kredi, rehin gibi borçlar bulunmamalıdır.</li>
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> İlanınızın satışa çıkarılmasına onay verdiğinizde minimum 90 gün olarak düzenlenmiş yetkilendirme sözleşmesi gerekmektedir.</li>
                                                <li><span class="fa-li"><i class="fas fa-circle"></i></span> Bu şartları sağladığınızda gayrimenkulünüz satış süreci başlatılmış olur.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
@section('styles')
    ...
    <style>
        ...
        .btn-link:hover {
            ...
            outline: none !important; /* Buton odaklandığında etrafındaki kenarlığı da kaldır */
        }

        .kategori-container {
            text-align: center; /* Kategorileri yatayda ortala */
        }

        .kategori-listesi {
            list-style-type: none; /* Sırasız liste öğelerinin işaretlerini kaldır */
            padding: 0;
            margin: 0;
        }

        .kategori {
            display: inline-block; /* Yatayda hizala */
            padding: 5px 10px;
