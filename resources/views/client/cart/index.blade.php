                        ...
                        <div class="clearButtons">
                            @if (isset($cart['item']))
                                <button type="button" class="btn btn-close-cart remove-from-cart"
                                    style="background: #D32729;padding:5px;height:auto !important; color: white; font-size: 12px;">
...
$number_of_share = $cart['item']['numbershare'] ?? null;
                                        ...
                                        <td>
                                            ...
                                            @if ($discountRate != 0)
                                                <span>
                                                    <del
                                                        style="color:#D32729">{{ number_format($cart['item']['amount'], 0, ',', '.') }}₺</del>
                                                </span>
                                            @endif
                                ...
                                @else
                                    <ul>
                                        ...
                                        @if ($housingDiscountAmount != 0 || $projectDiscountAmount != 0)
                                            <li style="color:#D32729">Mağaza İndirimi :
                                        ...
                                        @if (isset($discountRate) && $discountRate != '0')
                                            <li style="color:#D32729">Emlak Kulüp İndirim Oranı :<strong class="pull-right">
                                                    <svg viewBox="0 0 24 24" width="18" height="18"
                                                        stroke="currentColor" stroke-width="2" fill="none"
                                                        stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                                        <polyline points="23 18 13.5 8.5 8.5 13.5 1 6"></polyline>
                                        ...
                                        @endphp
                                            ...
                                            {{-- <li>Hizmet Bedeli :<strong
                                                    ...
                                                    TL</strong></li> --}}
                                            {{-- <span class="text-muted" style="color:#D32729 !important;">Hizmet bedeli, kapora
                                ...
                                <div class="invoice-body">
                                    <div class="invoice-total mt-3">
                                        ...
                                        <span>Ödeme işlemini tamamlamak için, lütfen bu
                                            <span style="color:#D32729;font-weight:bold" id="uniqueCode"></span> kodu
