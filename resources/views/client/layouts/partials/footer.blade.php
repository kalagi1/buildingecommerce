                            ...
                            <div class="nav-footer">
                                <ul>
                                    ...
                                    @foreach (App\Models\Page::where('widget', $widgetGroup->widget)->get() as $p)
                                        @if ($p->slug != 'bireysel-uyelik-sozlesmesi' && $p->slug != 'kurumsal-uyelik-sozlesmesi' && $p->slug != 'mesafeli-kiralama-sozlesmesi')
