...
<div class="button-container">
    ...
    <a href="{{ Auth::check() ? (Auth::user()->type == 1 ? route('client.index') : (Auth::user()->type == 2 ? route('institutional.index') : (Auth::user()->type == 3 ? route('admin.index') : 'client.login'))) : 'client.login' }}"
        class="button">
        <button class="button">
