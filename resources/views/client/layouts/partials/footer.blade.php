                ...
                success: function(data) {
                    ...
                    if (data.projects.length > 0) {
                        ...
                        data.projects.forEach((e) => {
                            ...
                            var baseRoute = `{{ route('project.detail', ['slug' => 'slug_placeholder', 'id' => 'id_placeholder']) }}`.replace('slug_placeholder', e.slug).replace('id_placeholder', parseInt(e.id) + 2000000);
