...
@section('content')
    <section>
        <div class="brand-head">
            <div class="container">
                <div class="card mb-3">
                    <div class="card-img-top" style="background-color: {{ $store->banner_hex_code ?? '#000' }}">
                        <div class="brands-square w-100">
                            <img src="{{ url('storage/profile_images/' . $store->profile_image) }}" alt=""
                                class="brand-logo">
                            <p class="brand-name"><span style="color:White">
                                    {{ $store->name }}
                                    <style type="text/css">
                                        .st0 {
                                            fill: #274abb;
                                    ...
                                    <tbody class="collection-title">
                                        ...
                                        @foreach ($mergedItems as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a                                              
                                                        href="{{ $item['item_type'] == 1 ? route('project.housings.detail', ['projectSlug'=> $item['project']['slug'],'projectID'=> $item['project']['id']+1000000,'housingOrder'=> $item['room_order']]) : route('housing.show', ['housingSlug' => $item['housing']->slug ,'housingID'=> $item['housing']->id +2000000 ] ) }}">
                                                        ...
                                                        @else
                                                            ...
                                                            <script>
                                                                function redirectToReservation() {
                                                                    window.location.href = "{{ route('housing.show', ['housingSlug' => $item['housing']->slug ,'housingID'=> $item['housing']->id +2000000 ] ) }}";
                                                                }
                                                            </script>
                                                        @endif
                                                    @else
