                                                ...
                                                <td>
                                                    ...
                                                    @elseif (
                                                        ...
                                                        @php
                                                            ...
                                                            $discountedPrice = number_format(($item['item_type'] == 1 ? $item['project_values']['price[]'] : json_decode($item['housing']['housing_type_data'])->price[0]) - (($item['item_type'] == 1 ? $item['project_values']['price[]'] : json_decode($item['housing']['housing_type_data'])->price[0]) * $discountRate) / 100, 0, ',', '.');
                                                        @endphp
                                                        <span style="color: green; font-size:15px !important">
                                                            {{ $discountedPrice }} ₺
                                                        </span><br>
                                            ...
                                            <div class="d-flex" style="align-items:Center">
                                                ...
                                                <span class="ml-auto text-primary priceFont">
                                                    <td>
                                                        ...
                                                        @elseif ($item['item_type'] == 2 && isset(json_decode($item['housing']['housing_type_data'])->discount_rate[0]) && json_decode($item['housing']['housing_type_data'])->discount_rate[0])
                                                            @php
                                                                $discountRate = json_decode($item['housing']['housing_type_data'])->discount_rate[0];
                                                                $discountedPrice = number_format(($item['item_type'] == 1 ? $item['project_values']['price[]'] : json_decode($item['housing']['housing_type_data'])->price[0]) - (($item['item_type'] == 1 ? $item['project_values']['price[]'] : json_decode($item['housing']['housing_type_data'])->price[0]) * $discountRate) / 100, 0, ',', '.');
                                                            @endphp
