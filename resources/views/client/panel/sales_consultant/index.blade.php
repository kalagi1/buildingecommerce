                                ...
                                <div class="modal-body">
                                    <form action="{{route('institutional.assign.project.user')}}" method="POST">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div id="projects{{$index}}" style="max-height: 300px; overflow-y: auto;"> <!-- Scrollbar eklendi -->
                                                @foreach ($projects as $project)
                                                    <div class="form-check mt-3">
                                                        <input type="hidden" name="user_id" value="{{$item->id}}">
                                                        <input class="form-check-input mr-3" type="checkbox" name="projectIds[]" value="{{ $project->id }}" id="project{{$index}}_{{$project->id}}">
                                                        <label class="form-check-label" for="project{{$index}}_{{$project->id}}" style="margin-left: 24px !important;">
                                        ...
                                        <div class="col-12 d-flex justify-content-between mt-2 mb-2"> <!-- Flexbox ile düzenleme -->
