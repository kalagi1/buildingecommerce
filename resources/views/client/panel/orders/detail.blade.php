                ...
                <div class="order-item">
                    ...
                    <div class="order-item-body">
                        ...
                        <div class="order-item-details">
                            ...
                            <p class="text-muted">
                                @if ($o->type == 'housing')
                                    {{ json_decode(App\Models\Housing::with('store')->find(json_decode($order->cart)->item->id ?? 0))->store->name }}
                                @else
                                    {{ json_decode(App\Models\Project::with('store')->find(json_decode($order->cart)->item->id ?? 0))->store->name }}
                                @endif
                            </p>
                        </div>
