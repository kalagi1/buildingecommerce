    ...
    <div class="content">
        <div class="mb-9">
            <div class="row g-3 mb-4">
                <div class="col-auto">
                    <h3 class="mb-0">Emlak Kulüp Üyeleri</h2>
                </div>
            </div>
            <div id="orderTable"
                                ...
                                @if ($estateClubUsers->count() > 0)
                                    @foreach ($estateClubUsers as $user)
                                        <tr>
                                            ...
                                            <td class="order_no"><a href="{{route('institutional.estate.create.coupon',$user->id)}}" class="btn btn-sm btn-primary">Kupon Tanımla</a></td>
                                        </tr>
                                    @endforeach
                                @else
                                    <tr>
