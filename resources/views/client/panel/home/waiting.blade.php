    ...
    <div class="content">
        ...
        <div class="p-5 bg-white border rounded-3 shadow-lg">
            ...
            <div class="row flex-center py-5">
                <div class="col-sm-10 col-md-8 col-lg-5 col-xxl-4 mx-auto">
                    <div class="d-flex align-items-center fw-bolder fs-3 d-inline-block justify-content-center mb-3"><img
                        ...
                        <div class="px-xxl-5">
                            <div class="text-center mb-6">
                                <h2 class="text-body-highlight" >Kurumsal Dünyaya Hoşgeldiniz</h2>
                                
                                <div class="px-xxl-5">
                                    <div class="text-center mb-6">
                                        <p class="text-body-tertiary mb-5" style="font-size: 16px;">Telefon doğrulaması başarıyla gerçekleşti.</p>                                   
                                    </div>
                                </div>

                                <p class="text-body-tertiary mb-4" style="font-size: 16px;">
