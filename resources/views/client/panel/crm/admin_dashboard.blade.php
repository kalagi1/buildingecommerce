                    ...
                    @if($award->status == 1)
                        <div class="col-md-4">
                            <div style="position: relative;">
                                ...
                                <img src="{{ asset('awards/' . $award->award_image) }}" alt="{{ $award->title }}" style="position: absolute; top: 56%; left: 82%;max-width: 50px;">
                        ...
                        @foreach ($satisDanismanlari as $danisman)
                            @foreach ($danismanVerileri[$danisman->id]['satis_detaylari'] as $satisDetayi)
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('storage/profile_images/' . $musteri->profile_image ?: 'default_profile.png') }}" alt="" style="width: 30px; height: 30px" class="rounded-circle" />
...
@section('styles')
    ...
    <style>
        ...
        .cardDanismanList{
            padding: 0px 20px;
            border-top: 1px solid #D32729; /* Top border color */
            border-bottom: 1px solid #D32729; /* Bottom border color */
