    ...
    <div class="content">
                    ...
                    <div class="card-statistic-3" style="padding: 1rem 1rem ">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h2 class=" ml-3 d-flex align-items-center mb-0 text-white">{{ $positiveCustomersCount }}
                                </h2>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-3">
                <div class="card l-bg-red">
                    <div class="card-statistic-3" style="padding: 1rem 1rem ">
                        <div class="d-flex align-items-center">
                            <div class="divSvg">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 32 32"
                                    fill="none">
                                    <g clip-path="url(#clip0_133_200)">
                                        <path
                                            d="M10.6682 10.6668C10.6682 7.72131 13.0569 5.3335 16.0036 5.3335C18.9502 5.3335 21.3389 7.72131 21.3389 10.6668C21.3389 13.6123 18.9502 16.0002 16.0036 16.0002C14.5886 16.0002 13.2315 15.4383 12.2309 14.4381C11.2303 13.4379 10.6682 12.0813 10.6682 10.6668ZM26.5276 24.7335L24.6068 20.8802C23.9282 19.5213 22.5382 18.6638 21.0188 18.6668H10.9884C9.46897 18.6638 8.07898 19.5213 7.40033 20.8802L5.4796 24.7335C5.27156 25.1462 5.29214 25.6371 5.53397 26.031C5.77581 26.4248 6.20442 26.6654 6.66672 26.6668H25.3404C25.8027 26.6654 26.2314 26.4248 26.4732 26.031C26.715 25.6371 26.7356 25.1462 26.5276 24.7335Z"
                                            fill="url(#paint0_linear_133_200)" />
                                        <circle cx="25.5" cy="23.5" r="4.5" fill="white" />
                                        <g clip-path="url(#clip1_133_200)">
                                            <path
                                                d="M26.4955 20.2915V19.2419C26.4946 19.1798 26.5195 19.1201 26.5643 19.0769L26.656 18.9853C26.6991 18.9419 26.7578 18.9175 26.8189 18.9175C26.8801 18.9175 26.9387 18.9419 26.9818 18.9853L28.606 20.6032C28.694 20.6938 28.694 20.8379 28.606 20.9286L26.9818 22.5465C26.9387 22.5899 26.8801 22.6143 26.8189 22.6143C26.7578 22.6143 26.6991 22.5899 26.656 22.5465L26.5643 22.4549C26.5195 22.4117 26.4946 22.352 26.4955 22.2899V21.2082C25.0036 21.2126 23.7867 22.4033 23.7515 23.8932C23.7162 25.3831 24.8755 26.63 26.3655 26.7047C27.8555 26.7795 29.134 25.655 29.2483 24.169C29.2579 24.0497 29.3579 23.9578 29.4777 23.9582H29.9366C30.0007 23.9588 30.0619 23.9853 30.1063 24.0315C30.148 24.0778 30.1695 24.1389 30.166 24.2011C30.0338 26.1891 28.3367 27.708 26.344 27.6214C24.3514 27.5348 22.7926 25.8745 22.8338 23.8825C22.875 21.8905 24.501 20.2959 26.4955 20.2915Z"
                                                fill="url(#paint1_linear_133_200)" />
                                        </g>
                                    </g>
                                    <defs>
                            ...
                            <div>
                                ...
                                <h2 class=" ml-3 d-flex align-items-center mb-0 text-white">
                                    {{ $geri_donus_yapilacak_musterilerCount }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-3">
                <div class="card l-bg-red">
                    <div class="card-statistic-3" style="padding: 1rem 1rem ">
                        <div class="d-flex align-items-center">
                            <div class="divSvg">
                                <svg width="26" height="28" viewBox="0 0 32 33" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_134_365)">
                                        <path
                                            d="M9.33132 9.625C9.33132 6.58743 11.72 4.125 14.6667 4.125C17.6133 4.125 20.002 6.58743 20.002 9.625C20.002 12.6626 17.6133 15.125 14.6667 15.125C13.2516 15.125 11.8946 14.5455 10.894 13.5141C9.89343 12.4826 9.33132 11.0837 9.33132 9.625ZM25.1906 24.1313L23.2699 20.1575C22.5913 18.7562 21.2013 17.8719 19.6819 17.875H9.65144C8.13206 17.8719 6.74207 18.7562 6.06341 20.1575L4.14269 24.1313C3.93465 24.5568 3.95522 25.0631 4.19706 25.4693C4.43889 25.8754 4.8675 26.1236 5.3298 26.125H24.0035C24.4658 26.1236 24.8944 25.8754 25.1363 25.4693C25.3781 25.0631 25.3987 24.5568 25.1906 24.1313Z"
                                            fill="url(#paint0_linear_134_365)" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M22.3056 28.5584C20.3758 28.5582 16.7734 24.6628 16.7734 22.737C16.7734 20.8112 18.3378 19.25 20.2675 19.25C21.0347 19.25 21.7442 19.4968 22.3206 19.9152C22.8915 19.4963 23.5898 19.25 24.3438 19.25C26.2735 19.25 27.8379 20.8632 27.8379 22.8532C27.8379 24.8432 24.2354 28.5582 22.3057 28.5584"
                                            fill="white" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M22.2477 26.8125C20.965 26.8125 18.5703 24.223 18.5703 22.9429C18.5703 21.6628 19.6102 20.625 20.8929 20.625C21.403 20.625 21.8747 20.7891 22.2579 21.0673C22.6374 20.7888 23.1016 20.625 23.603 20.625C24.8857 20.625 25.9255 21.6973 25.9255 23.0202C25.9255 24.343 23.5308 26.8125 22.2481 26.8125C22.2481 26.8125 22.248 26.8123 22.2479 26.812C22.2478 26.8123 22.2477 26.8125 22.2477 26.8125Z"
        ...
        <div class="row mb-3" style="margin-left:0px; ">
            <div class="col-md-6 bestDiv">
                <h5>En Çok Satış Yapan Danışmanlar</h5>
                <hr>
                            ...
                            <div class="cardDanisman">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center" style="border-radius: 55%;">
                                        <img src="{{ asset('storage/profile_images/' . $topCaller->profile_image) }}"
                        ...
                        <div class="cardDanisman">
                            ...
                            <div class="card-body">
                                <div class="text-center" style="border-radius: 55%">
                                    ...
                                    @if ($enCokSatisYapan && $enCokSatisYapan->profile_image)
                                        <img src="{{ asset('storage/profile_images/' . $enCokSatisYapan->profile_image) }}"
                                            class="danismanListImg">
                                    @endif
                        ...
                        <div class="col-md-4">
                            <div style="position: relative;">
                                ...
                                <h4
                                    ...
                                    {{ $award->title }}</h4>
                                <h4
                                    style="position: absolute; bottom: 35px; left: 135px; color: white; z-index: 10;font-size:13px;">
                                    {{ $award->award_name }}</h4>
                            </div>
                        </div>
                    @endif
        ...
        <div id="danismanCarousel" class="row bestDiv mb-3 carousel slide" style="padding: 0px 20px 40px 0px"
            data-ride="carousel">
                                    ...
                                    <div class="cardDanismanList">
                                        <div class="card-body">
                                            <div class="text-center" style="border-radius: 55%">
                                                ...
                                                <img src="{{ asset('storage/profile_images/' . $danisman->profile_image ?: 'woman.png') }}"
                                                    class="danismanListImg">
                                            </div>
                                            <p class="text-center"
                                                ...
                                                <div class="row">
                                                    <div class="col-6 border-right border-top">
                                                        <div class="stat-item">
                                                            ...
                                                            <h3>
                                                                <h3>{{ $danismanVerileri[$danisman->id]['satis_sayisi'] }}
                                                                </h3>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-6 border-right border-top">
                                                        <div class="stat-item">
                                                            ...
                                                            <h3>{{ $danismanVerileri[$danisman->id]['musteri_sayisi'] }}
                                                            </h3>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 border-top">
                                                        <div class="stat-item">
                                                            ...
                                                            <h3>{{ $danismanVerileri[$danisman->id]['donus_yapilan_musteri'] }}
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <a class="carousel-control-prev" href="#danismanCarousel" role="button" data-slide="prev">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="38" height="38"
                    style=" background-color: gainsboro;border-radius: 50%;padding: 7px;">
                    <path
        ...
        <div class="row bestDiv">
            ...
            <div class="col-md-4 stats-table">
                ...
                <table class="table mt-3" id="istatistik">
                    <tbody>
                        <tr>
                            <td><span class="icon-circle red-circle mr-4"></span> <span>Bireysel Satış
                                    İstatistikleri</span></td>
                            <td>{{ $sharerIndividualCount }}</td>

                        </tr>
                        <tr>
                            <td><span class="icon-circle orange-circle mr-4"></span> <span>Danışman Satış
                                    İstatistikleri</span></td>
                            <td>{{ $sharerEstateCount }}</td>

                        </tr>
                        <tr>
                            <td><span class="icon-circle blue-circle mr-4"></span> <span>Şirket Satış İstatistikleri</span>
                            </td>
                        ...
                        @foreach ($satisDanismanlari as $danisman)
                            @foreach ($danismanVerileri[$danisman->id]['satis_detaylari'] as $satisDetayi)
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('storage/profile_images/' . $musteri->profile_image ?: 'default_profile.png') }}"
                                    ...
                                    <td><span class="badge badge-success rounded-pill d-inline"
                                            style="font-size: 10px">{{ $satisDetayi->amount }}</span></td>
                                    <td>
...
@section('styles')
    ...
    <style>
        .medal-icon {
            font-size: 27px;
            line-height: 0;
            /* Ensures the icon doesn't affect the vertical alignment */
            margin-right: 120px;
        }
