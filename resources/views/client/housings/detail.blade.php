                                                            ...
                                                            @if (!isset(json_decode($housing->housing_type_data)->off_sale1[0]))
                                                                ...
                                                                @if ($discountAmount)
                                                                    <svg viewBox="0 0 24 24" width="18"
                                                                        height="18" stroke="#EC2F2E" stroke-width="2"
                                                                        fill="#EC2F2E" stroke-linecap="round"
                                                                ...
                                                                ₺
                                                                @if ($housing->step2_slug == 'gunluk-kiralik')
                                                                    <span style="font-size:12px; color:#EC2F2E">(1
                                                                        Gece)</span>
                                                                @endif
                                                            @endif
                                                        </h4>
                                                ...
                                                <div class="listing-title-bar mobileMovePrice w-100 p-0">
                                                    <h4
                                                        ...
                                                        @if (!isset(json_decode($housing->housing_type_data)->off_sale1[0]))
                                                            ...
                                                            ₺
                                                            @if ($housing->step2_slug == 'gunluk-kiralik')
                                                                <span style="font-size:12px; color:#EC2F2E">1 Gece</span>
                                                            @endif
                                                        @endif
                                                    </h4>
                                                </div>
                                                ...
                                                @if ($sold && isset($sold[0]) && $sold[0]->status != '2')
                                                    @php
                                                        ...
                                                        if ($sold && $sold[0]->status == '0') {
                                                            ...
                                                            $buttonStyle =
                                                                'background: #EC2F2E !important; width: 100%; color: white;';
                                                            $buttonText = 'Satıldı';
                                                        }
                                                    @endphp
                                        ...
                                        <form action="{{ route('form.kaydet') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="konutyse" style="display: none;" class="col-md-12 col-12">
                                                    ...
                                                    <label class="form-label" for="konut_satis_rakami">Düşündüğünüz Satış
                                                        Rakamı:</label>
