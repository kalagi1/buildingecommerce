                                    ...
                                    <div class="landscapes">
                                        <div class="project-single">
                                            <div class="project-inner project-head">
                                                <div class="homes">
                                                    <!-- homes img -->
                                                    <a href="{{route('housing.show', ['housingSlug' =>  $housing->slug, 'housingID' => $housing->id + 1000000]) }}" class="homes-img">
                                            ...
                                            <div class="homes-content p-3" style="padding:20px !important">
                                                <!-- homes address -->
                                                <h3><a
                                                        href="{{ route('housing.show', ['housingSlug' =>  $housing->slug, 'housingID' => $housing->id + 1000000]) }}">{{ $housing->title }}</a>
                                                </h3>
