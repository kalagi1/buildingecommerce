...
for ($i = 0; $i < count($array); $i++) { if ($i==0) { $html .=' ' . $array[$i]; } else { $html .=', ' . $array[$i]; } }
    return $html; } $projectHousings=[]; @endphp @php // Retrieve the necessary data
                            ...
                            <div class="schedule widget-boxed mt-33 mt-0 widgetBuyButton mb-5">
                                <div class="row buttonDetail" style="align-items:center;width:100%;margin:0 auto">
                                    ...
                                    <div class="col-md-6 col-6 mobile-action-move p-0">
                                        ...
                                        <span style="width:100%;text-align:center">
                                            ...
                                            @else
                                            <h6 style="color:#274abb; position: relative; top: 4px; font-weight: 700">
                                                {{ number_format($discounted_price, 0, ',', '.') }}
                                                ₺
                                            </h6>
                                            @endif
                                            ...
                                            <h6
                                                ...
                                                {{ number_format($projectHousingsList[$housingOrder]['price[]'] /
                                                $number_of_share, 0, ',', '.') }}
                                                ₺
                                                @else
                                                {{ number_format($projectHousingsList[$housingOrder]['price[]'], 0, ',',
                                ...
                                @else
                                    col-md-6 col-6 @endif "
                                        ...
                                        @elseif ($off_sale_4)
                                        @if (Auth::user())
                                        <button class="first-btn payment-plan-button" data-bs-toggle="modal" style="    height: 40px;
    /* padding: 15px; */
    color: white;
    font-size: 11px;
    ...
    display: flex;
    align-items: center;
    justify-content: center;" data-bs-target="#approveProjectModal{{ $housingOrder }}">
                                            TEKLİF VER
                                        </button>
                                        @else
                                        <a href="{{ route('client.login') }}" style="    height: 40px;
                                                /* padding: 15px; */
                                                color: white;
                                                font-size: 11px;
                                                background-color: black;
                                                ...
                                                display: flex;
                                                align-items: center;
                                                justify-content: center;" class="first-btn payment-plan-button">
                                            TEKLİF VER
                                        </a>
                                        @endif
                                        @endif
                        ...
                        <div class="moveCollection">
                            <div class="add-to-collections-wrapper addCollectionMobile addCollection"
                                data-type='project' data-id="{{ $housingOrder }}" data-project="{{ $project->id }}">
                                                ...
                                                <g id="Group 6131">
                                                    <g id="Frame 21409">
                                                        <g id="Group 6385">
                                                            ...
                                                            <g id="Group 2664">
                                                                <rect id="Rectangle 316" width="32" height="32" rx="4"
                                                                    fill="#ea2a28" />
                                                                <g id="Group 72">
                                            ...
                                            <form action="{{ route('form.kaydet') }}" method="POST" id="takasFormu"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12 mb-2">
                                                        ...
                                                        <input class="modal-input" type="text" id="ad" required
                                                            name="ad">
                                                    </div>

                                                    <div class="col-md-6 col-12 mb-2">
                                                        <label class="form-label" for="soyad">Soyadınız:</label>
                                                        <input class="modal-input" type="text" id="soyad" required
                                                            name="soyad">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12 mb-2">
                                                        <label class="form-label" for="telefon">Telefon
                                                            Numaranız:</label>
                                                        <input class="modal-input" type="number" id="telefon" required
                                                            name="telefon" maxlength="10">
                                                    </div>

                                                    <div class="col-md-6 col-12 mb-2">
                                                        <label class="form-label" for="email">E-mail:</label>
                                                        <input class="modal-input" type="email" id="email" required
                                                            name="email">
                                                    </div>

                                                    <div class="col-md-6 col-12 mb-2">
                                                        <label class="form-label" for="sehir">Şehir:</label>
                                                        <select class="modal-input" id="sehir" name="sehir" required>
                                                    ...
                                                    <div class="col-md-6 col-12 mb-2">
                                                        ...
                                                        <select class="modal-input" id="ilce" name="ilce" required
                                                            disabled>
                                                    ...
                                                    <div id="digeryse" style="display: none;"
                                                        ...
                                                        <textarea class="modal-input" id="diger_detay"
                                                            name="diger_detay"></textarea>
                                                    </div>
                                                    ...
                                                    <div id="barteryse" style="display: none;"
                                                        ...
                                                        <textarea class="modal-input" id="barter_detay"
                                                            name="barter_detay"></textarea>
                                                    </div>
                                                    ...
                                                    <div id="arsayse" style="display: none;"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label class="form-label" for="arsa_il">Arsa
                                                                    İl:</label>
                                                                <select class="modal-input" id="arsa_il" name="arsa_il">
                                                                    <option value="">Şehir Seçiniz</option>
                                                                    @foreach ($cities as $city)
                                                                    <option value="{{ $city->id }}">
                                                                        {{ $city->title }}</option>
                                                        ...
                                                        <label class="form-label" for="imar_durumu">Arsa İmar
                                                            Durumu:</label>
                                                        <select class="modal-input" id="imar_durumu" name="imar_durumu">
                                                            <option value="">Seçiniz</option>
                                                            <option value="villa">Villa</option>
                                                            <option value="konut">Konut</option>
                                                    ...
                                                    <div id="aracyse" style="display: none;" class="col-md-12 col-12 ">
                                                        ...
                                                        <div class="mb-2">
                                                            <label class="form-label" for="arac_satis_rakami">Satış
                                                                Rakamı:</label>
                                                            <input class="modal-input" type="text"
                                                                id="arac_satis_rakami" name="arac_satis_rakami" min="0">
                                                        </div>
                                                    ...
                                                    <div id="isyeriyse" style="display: none;"
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <textarea class="modal-input" id="ticari_bilgiler"
                                                                name="ticari_bilgiler"></textarea>
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <span class="det" style="color: #274abb !important;">
                                                            ...
                                                            convertMonthToTurkishCharacter(date('F',
                                                            strtotime($project->created_at))) . ' ' . date('Y',
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <span class="det">
                                                            <a style="text-decoration: none;color:#274abb;"
                                                                href="tel:{!! $project->user->mobile_phone !!}">{!!
                                                                $project->user->mobile_phone !!}</a>
                                                        </span>
                                                    </td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <span class="det" style="color: black;">{{ $project->island ?
                                                            $project->island : 'Belirtilmedi' }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <span class="autoWidthTr">Parsel:</span>
                                                        <span class="det" style="color: black;">{{ $project->parcel ?
                                                            $project->parcel : 'Belirtilmedi' }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <span class="autoWidthTr">Toplam Proje Alanı
                                                            m<sup>2</sup>:</span>
                                                        <span class="det" style="color: black;">{{
                                                            $project->total_project_area ? $project->total_project_area
                                                            : 'Belirtilmedi' }}</span>
                                                    </td>
                                                </tr>
                                            </table>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="situation-tab" data-bs-toggle="tab"
                                    data-bs-target="#situation" type="button" role="tab" aria-controls="situation"
                        ...
                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <tbody class="trStyle">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <span class="det">{{ $housingSetting->label == 'Fiyat' ?
                                                            number_format($value, 0, ',', '.') : $value }}</span>
                                                    </td>
                                                </tr>
                                                @endif
                                                @endforeach
                            ...
                            <div class="tab-pane fade show active   blog-info details housingsListTab mb-30 "
                                id="contact"
                                                ...
                                                <div class="tabbed-content button-tabs">
                                                    <ul class="tabs">
                                                        ...
                                                        <li class="nav-item-block {{ $key == $blockIndex ? ' active' : '' }}"
                                                            role="presentation" id="contentblocktab-{{ $block['id'] }}"
                                                    ...
                                                    <div id="contentblock-{{ $block['id'] }}"
                                                        ...
                                                        for ($j = 0; $j < $blockKey; $j++) { if ( isset($project->
                                                            blocks[$j]) &&
                                                ...
                                                @for ($i = 0; $i < min($project->room_count, 10); $i++)
                                                    ...
                                                    ->where('start_date', '<=', now()) ->where('end_date', '>=', now())
                                                        ...
                                                        <x-project-item-mobile-card :towns="$towns" :cities="$cities"
                                                            ...
                                                            :allCounts="$allCounts" :statusSlug="$statusSlug"
        ...
        <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB-ip8tV3D9tyRNS8RMUwxU8n7mCJ9WCl0&callback=initMap">
        </script>
