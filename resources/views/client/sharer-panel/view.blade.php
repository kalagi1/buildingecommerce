...
@section('content')
            ...
            <div class="container recently-slider">
                <div class="portfolio right-slider">
                    <div class="owl-carousel home5-right-slider" style="height: 550px">
                        <a href="{{ route('institutional.sharer.index') }}" class="recent-16" data-aos="fade-up"
                            data-aos-delay="150">
    ...
    @elseif (Auth::check() && Auth::user()->has_club == 1)
        ...
        @else
            <section class="recently portfolio bg-white homepage-5 mt-5 emlak-kulup-slider recently2">
                <div class="container recently-slider">
                    <div class="portfolio right-slider">
                        <div class="owl-carousel home5-right-slider" style="height: 550px">
                            <a href="{{ route('client.login') }}" class="recent-16" data-aos="fade-up" data-aos-delay="150">
                                <div class="recent-img16 sliderSize img-fluid img-center mobile-hidden"
                                    style="background-image: url(images/emlakKulupGorsel.png)"></div>
                                <div class="recent-img16 sliderSize img-fluid img-center mobile-show heitwo heithree"
                                    style="background-image: url(images/bannerNew_mobil.png);"></div>
                        ...
                        <div class="row align-items-center justify-content-center hw50">
                            ...
                            <div class="col-md-11 col-12" style="padding:0;height:100%">
                                <div class="service-text-p mobile-text"
                                    ...
                                    <p class="text-center">
                                        <a href="{{ url('/') }}" class="linkColor mr-2"
                                            style="color: #ea2a28;">Emlaksepette.com </a> üzerinden Emlak Kulübe üye ol.
                                    </p>
                                </div>
                            </div>
                    ...
                    <article class="col-lg-12 col-md-12 col-xs-12 serv aos-init aos-animate" data-aos="fade-up"
                        ...
                        <div class="row align-items-center justify-content-center hw50">
                            ...
                            <div class="col-md-11 col-12" style="padding:0;height:100%">
                                <div class="service-text-p mobile-text"
                                    style="background-color: black; color: white;height:100%">
                                    <p class="text-center">İstediğin kadar ilanı koleksiyonuna ekleyip sana özel oluşturulan
                                        link ile kendi sosyal medya hesaplarından paylaş. </p>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center justify-content-center hw50">
                            ...
                            <div class="col-md-11 col-12" style="padding:0;height:100%">
                                <div class="service-text-p mobile-text"
                                    style="background-color: black; color: white;height:100%">
                                    <p class="text-center">
                                        Böylece paylaştığın ve satışla sonuçlanan her ilan için bizimle beraber
                                        sende kazanırsın.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <ul class="accordion accordion-1 one-open">
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <p>
                                        Emlaksepette.com’ da bulunan proje ilanlarını koleksiyonuna ekleyerek paylaşım
                                        yaptığın
                                        ...
                                        paylaşmış olduğun link üzerinde satılması karşılığında emlak sepette.com emlak
                                        kulübü
                                        üyesine vergiler düşülerek net
                                        78 bin tl nakit ödeme yapar)
                                        Emlaksepette.com’ da bulunan emlak ilanlarını koleksiyonuna ekleyerek paylaşım
                                        yaptığın
                                        ilanların satılması durumunda
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <p>
                                        Emlaksepette.com Paylaştıkça Kazan'da ilan paylaşımında sınır yok istediğin kadar
                                        ilanı
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <p>
                                        Emlak kulüp üyeleri Paylaştıkça Kazan kampanyasına göre emlaksepete.com üzerindeki
                                        tüm
                            ...
                            <li>
                                <div class="title">
                                    <span>Paylaştığım linkten gelen kişiler kaç gün içinde satın alma yaparsa benim
                                        kazancıma
                                ...
                                <div class="content">
                                    <p>
                                        Oluşturulan paylaştıkça kazan linki üzerinden emlaksepette.com ‘a gelen kullanıcının
                                        24
                            ...
                            <li>
                                <div class="title">
                                    <span>Koleksiyonuma eklediğim ilanların linkini paylaşımından sonra fiyat değişikliği
                                        olursa
                                        ne olur?
                                    </span>
                                    <i class="accordion-toggle-icon fas fa-chevron-right"></i>
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <p>
                                        Emlaksepette.com Paylaştıkça Kazan kampanyasından elde ettiğin kazancını alabilmen
                                        için
                                        ödeme bilgilerini eksiksiz ve
                                        doğrubir şekilde girmiş olman gerekiyor. Ödeme bilgilerin tamamlanmışsa üyelikte
                                        bizlere
                                        ilettiğin IBAN- hesap numarasına
                                        kazancın nakit olarak iletilecektir. Emlaksepette.com şahıs ödemeleri kapsamında
                                        ilgili
                                        kullanıcıların adına gider pusulası
                                        düzenleyip, oluşan stopaj maliyetinin ödemesini de kendi tarafında üstlenecektir
                                        fakat
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <p>
                                        Emlaksepette.com Paylaştıkça Kazan'da gelir elde edebilmek için aydınlatma metnine
                                        ve
                                        taahütnameye onay vermelisin.
                                        Aydınlatma metninin onaylanmadığı durumlarda paylaşım yapılsa da kazanç elde
                                        edilemez.
                                    </p>
                                </div>
                            </li>
                    ...
                    <div class="col-md-4 rigthSide gradient-overlay background-image"
                        ...
                        <div class="right-side-inner">
                            <h2 class="background-title">
                                Emlaksepette.com ‘da yer alan yüzbinlerce proje ilanını ve emlak ilanlarını seç ve bütün
                                dünya
                                ile paylaş. <br><br>
                                Aylık 50.000
                                TL ile 500.000 tl arasında linklerinden nakit gelir elde etme hakkı kazan! <br><br> Emlak
                                kulüp
        ...
        <section class="how-it-works bg-white rec-pro">
            <div class="container">
                <div class="row service-1">
                    ...
                    <article class="col-lg-3 col-md-6 col-xs-12 serv mb-0 pt its-2 aos-init aos-animate"
