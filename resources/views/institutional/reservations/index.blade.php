                                        ...
                                        @if ($confirmReservations->count() > 0)
                                            @foreach ($confirmReservations as $order)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="order_date">
                                                        <span style="color:#EC2F2E; font-weight:600;font-size:16px"><i class="fas fa-calendar"></i>
                                        ...
                                        @if ($refundedReservations->count() > 0)
                                            @foreach ($refundedReservations as $order)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="order_status">{!! [
                                                        '0' => '<span class="text-warning">İade Edildi</span>',
                                                        '1' => '<span class="text-success">İade Onaylandı</span>',
                                                        '2' => '<span class="text-danger">İade Reddedildi</span>',
                                                        '3' => '<span class="text-danger">İade Geri Ödemesi Yapıldı</span>',
