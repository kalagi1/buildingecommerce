...
@section('content')
    <div class="content">
                            ...
                            <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <svg height="50px" width="50px" version="1.1" id="Layer_1"
                                        ...
                                        <g>
                                            <path style="fill:#f52900;" d="M72.718,44.346L9.684,123.308C8.27,125.08,7.5,127.28,7.5,129.547v110.936h46.924v-42.219
      ...
      C84.345,39.331,76.721,39.331,72.718,44.346z" />
                                            <path style="fill:#55aaff;" d="M211.382,123.308l-63.034-78.962c-4.003-5.015-11.627-5.015-15.63,0l-22.185,27.791l40.849,51.171
      ...
      C213.567,127.28,212.796,125.08,211.382,123.308z" />
       ...
       C273.567,127.28,272.796,125.08,271.382,123.308z" />
                                                <path style="fill:#e83d04;" d="M277.242,118.628l0.001,0.001L214.21,39.667c-7.015-8.786-20.353-8.768-27.354,0l-16.323,20.448
