                    ...
                    <div class="row align-items-center g-4">
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><span class="fa-stack"
                                    style="min-height: 46px;min-width: 46px;"><svg
                                        class="svg-inline--fa fa-square  dark__text-opacity-50 text-success-light"
                                        data-fa-transform="down-4 rotate--10 left-4" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="square" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""
                                        style="transform-origin: 0.1875em 0.75em;">
                                    ...
                                    </svg><!-- <span class="fa-solid fa-square  dark__text-opacity-50 text-success-light" data-fa-transform="down-4 rotate--10 left-4"></span> Font Awesome fontawesome.com --><svg
                                        class="svg-inline--fa fa-circle  stack-circle text-stats-circle-success"
                                        data-fa-transform="up-4 right-3 grow-2" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="circle" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""
                                        style="transform-origin: 0.6875em 0.25em;">
                                    ...
                                    </svg><!-- <span class="fa-solid fa-circle  stack-circle text-stats-circle-success" data-fa-transform="up-4 right-3 grow-2"></span> Font Awesome fontawesome.com --><svg
                                        class="svg-inline--fa fa-star fa-stack-1x text-success"
                                        data-fa-transform="shrink-2 up-8 right-6" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="star" role="img" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 576 512" data-fa-i2svg="" style="transform-origin: 0.9375em 0em;">
                                    ...
                                    </svg><!-- <span class="fa-stack-1x fa-solid fa-star text-success " data-fa-transform="shrink-2 up-8 right-6"></span> Font Awesome fontawesome.com --></span>
                                <div class="ms-3">
                        ...
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><span class="fa-stack"
                                    style="min-height: 46px;min-width: 46px;"><svg
                                        class="svg-inline--fa fa-square  dark__text-opacity-50 text-warning-light"
                                        data-fa-transform="down-4 rotate--10 left-4" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="square" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""
                                        style="transform-origin: 0.1875em 0.75em;">
                                    ...
                                    </svg><!-- <span class="fa-solid fa-square  dark__text-opacity-50 text-warning-light" data-fa-transform="down-4 rotate--10 left-4"></span> Font Awesome fontawesome.com --><svg
                                        class="svg-inline--fa fa-circle  stack-circle text-stats-circle-warning"
                                        data-fa-transform="up-4 right-3 grow-2" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="circle" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""
                                        style="transform-origin: 0.6875em 0.25em;">
                                    ...
                                    </svg><!-- <span class="fa-solid fa-circle  stack-circle text-stats-circle-warning" data-fa-transform="up-4 right-3 grow-2"></span> Font Awesome fontawesome.com --><svg
                                        class="svg-inline--fa fa-pause fa-stack-1x text-warning"
                                        data-fa-transform="shrink-2 up-8 right-6" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="pause" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""
                                        style="transform-origin: 0.6875em 0em;">
                                    ...
                                    </svg><!-- <span class="fa-stack-1x fa-solid fa-pause text-warning " data-fa-transform="shrink-2 up-8 right-6"></span> Font Awesome fontawesome.com --></span>
                                <div class="ms-3">
                        ...
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><span class="fa-stack"
                                    style="min-height: 46px;min-width: 46px;"><svg
                                        class="svg-inline--fa fa-square  dark__text-opacity-50 text-danger-light"
                                        data-fa-transform="down-4 rotate--10 left-4" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="square" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""
                                        style="transform-origin: 0.1875em 0.75em;">
                                    ...
                                    </svg><!-- <span class="fa-solid fa-square  dark__text-opacity-50 text-danger-light" data-fa-transform="down-4 rotate--10 left-4"></span> Font Awesome fontawesome.com --><svg
                                        class="svg-inline--fa fa-circle  stack-circle text-stats-circle-danger"
                                        data-fa-transform="up-4 right-3 grow-2" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="circle" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""
                                        style="transform-origin: 0.6875em 0.25em;">
                                    ...
                                    </svg><!-- <span class="fa-solid fa-circle  stack-circle text-stats-circle-danger" data-fa-transform="up-4 right-3 grow-2"></span> Font Awesome fontawesome.com --><svg
                                        class="svg-inline--fa fa-xmark fa-stack-1x text-danger"
                                        data-fa-transform="shrink-2 up-8 right-6" aria-hidden="true" focusable="false"
                                    ...
                                    </svg><!-- <span class="fa-stack-1x fa-solid fa-xmark text-danger " data-fa-transform="shrink-2 up-8 right-6"></span> Font Awesome fontawesome.com --></span>
                                <div class="ms-3">
