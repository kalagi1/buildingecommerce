...
<div class="content">
    <nav class="mb-2 breadcrumb-sticky-top" aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item active">Admin Emlak Kayıtları</li>
      </ol>
    </nav>
    <h2 class="text-bold mb-5 page-title-sticky-top">Admin Emlak Kayıtları</h2>
                  ...
                  <div class="col">
                    <div class="d-flex justify-content-between">
                      <div class="d-flex mb-2">
                        <h6 class="lh-sm mb-0 me-2 text-800 timeline-item-title">@if($log->is_rejected) Emlak Reddedildi @else Yeni Bir Kayıt @endif</h6>
                      </div>
