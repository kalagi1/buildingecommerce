                    ...
                    <a href="{{ route('institutional.project.create.v2') }}">
                        <div class="cardx 1">
                            <div class="card_image"> 
                                <img
                                    src="https://www.emlakrotasi.com.tr/wp-content/uploads/2021/10/Emlak-konut-kampanyasi.jpg" />
                            </div>
                    ...
                    <a href="{{ route('institutional.housing.create.v2') }}">
                        <div class="cardx 1">
                            <div class="card_image"> <img
                                    src="https://emsal.com/wp-content/uploads/2023/08/konut-fiyatlari-2023-scaled.jpg" />
                            </div>
                            <div class="card_title title-white">
