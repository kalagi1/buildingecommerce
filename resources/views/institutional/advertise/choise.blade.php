                ...
                <div class="group-icon">
                    <div class="box-icons d-flex">
                        ...
                        <div class="contents">
                            ...
                            <p class="font-2 text-color-2">                    Kendi proje ilanınızı ekleyin ve hayalinizdeki projenizi paylaşın. Binlerce kişiye ulaşın!
                            </p>
                        </div>
                    </div>
                    <div class="button-footer center">
                        <a class="sc-button" href="{{ route('institutional.project.create.v2') }}">  
                ...
                <div class="group-icon">
                    <div class="box-icons d-flex">
                        ...
                        <div class="contents">
                            ...
                            <p class="font-2 text-color-2"> Kendi emlak ilanınızı ekleyin ve ev, daire veya arsa satışınızı hızlandırın. Hemen ilan verin!</p>
                        </div>
                    </div>
                    <div class="button-footer center">
                        <a class="sc-button" href="{{ route('institutional.housing.create.v2') }}">                            
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
