                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="icon-input">
                                            ...
                                            <input type="text" value="{{isset($tempData->island) && $tempData->island ?  number_format(str_replace('.','',$tempData->island), 0, ',', '.')  : ''}}" class="total_project_area price-only" onkeyup="changeData(this.value,'island')">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="icon-input">
                                            ...
                                            <input type="text" value="{{isset($tempData->parcel) && $tempData->parcel ?  number_format(str_replace('.','',$tempData->parcel), 0, ',', '.')  : ''}}" class="total_project_area price-only" onkeyup="changeData(this.value,'parcel')">
                                        </div>
                                    </div>
