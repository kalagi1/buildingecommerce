...
@section('content')
    <div class="mobileApp">
        <div class="content">
            <span>Proje eklemek için lütfen web masaüstü versiyonu kullanın.</span>
        ...
        <div class="pop-up-v4 d-none">
            ...
            <div class="pop-content">
                <div class="load-area2">
                    <div class="progress2">
                        <div class="progress-bar2" role="progressbar" aria-valuenow="0" aria-valuemin="0"
            ...
            <div class="row w-100">
                <div class="col-md-12 mbpx-10">
                    <div class="row jc-space-between ">
                        ...
                        <div class="col-md-5">
                            <div class="show-houing-order ">
                                <div class="full-load" style="width: 0%"></div> <span>Daire <span
                                        class="room-order-progress">1</span> / <span
                                        class="percent-housing">0</span>%</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row" style="justify-content: space-between;">
                        <div class=" col-md-4">
                            <div class="button-white prev-house-bottom disabled-button">
                                <i class="fa fa-circle-chevron-left"></i> <span class="ml-5px last-housing-text">Önceki
                                    @if ($housingTypeTempX)
                                        {{ $housingTypeTempX->title }} @endif
                                </span>
                            </div>
                        </div>
                        <div class="button-white2 col-md-4">
                            <input type="text" value="1" class="form-control house_order_input"><span>/</span><span
                                class="total-house-text">
                                @if (isset($tempData->has_blocks) && $tempData->has_blocks)
                                    {{ isset($tempData->house_count0) ? $tempData->house_count0 : '' }}
                                @else
                                    {{ isset($tempData->house_count) ? $tempData->house_count : '' }} @endif
                            </span>
                        </div>
                        <div class="col-md-4">
                            <div class="button-white next-house-bottom">
                                <span class="mr-5px next-housing-text">Sonraki @if ($housingTypeTempX) {{ $housingTypeTempX->title }}
                                    @endif
                                </span> <i class="fa fa-circle-chevron-right"></i>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="area-listx">
                                <ul>
                                    @foreach ($housing_status as $status)
                                        <li @if (isset($tempData->statuses) && in_array($status->id, $tempData->statuses)) class="selected" @endif
                                            attr-id="{{ $status->id }}">{{ $status->name }}</li>
                                    @endforeach
                                </ul>
                            </div>
                                ...
                                <ul>
                                    @if (isset($tempDataFull->data) && isset($tempData->step1_slug) && $tempData->step1_slug)
                                        @foreach ($secondAreaList as $secondAreaItem)
                                            <li @if ($tempData->step2_slug == $secondAreaItem->slug) class="selected" @endif
                                ...
                                <ul>
                                    @if (isset($tempDataFull->data) &&
                                        ...
                                        @foreach ($housingTypes as $housingType)
                                            <li @if ($tempData->step3_slug == $housingType->slug) class="selected" @endif
                        ...
                        <div class="form-area mt-4">
                                ...
                                <div class="max-character-input">
                                    <div class="row" style="align-items:center;">
                                        <div class="input col-md-10">
                                            <input type="text"
                                                value="{{ isset($tempData->name) ? $tempData->name : '' }}"
                                                name="name" class="form-control advert_title">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="max-character"
                                                for="">{{ isset($tempData->name) ? Str::length(trim($tempData->name)) : '0' }}/70</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group description-field">
                                ...
                                <textarea name="description" id="editor" cols="30" rows="5"
                                    onkeyup="changeData(this.value,'description')" class="form-control">{{ isset($tempData->description) ? $tempData->description : '' }}</textarea>
                            </div>
                            <div class="form-group description-field">
                                <label for="">Bu Projede Bloklar Var mı? <span class="required">*</span></label>
                                <div class="form-group">
                                    <input type="radio" @if (isset($tempData->has_blocks) && $tempData->has_blocks) checked @endif
                                        class="has_blocks_input" name="has_blocks" value="1" id="yes"><label
                                        for="yes">Evet</label>
                                    <input type="radio" @if (isset($tempData->has_blocks) && !$tempData->has_blocks) checked @endif
                                        class="has_blocks_input" name="has_blocks" value="0" id="no"><label
                                        for="no">Hayır</label>
                                </div>
                            </div>
                            <h4
                                class="d-flex ai-center has_blocks-open @if (isset($tempData->has_blocks)) @if (!$tempData->has_blocks) d-none @endif
@else
d-none  @endif">
                                Bloklar <div class="add-block-button"><i class="fa fa-plus"></i></div>
                            </h4>
                            <div
                                class="blocks has_blocks-open @if (isset($tempData->has_blocks)) @if (!$tempData->has_blocks) d-none @endif
@else
d-none @endif">
                            ...
                            <h4
                                class="mb-3 housings_title has_blocks-close @if (isset($tempData->has_blocks)) @if ($tempData->has_blocks) d-none @endif
@else
d-none @endif">
                                Bu @if (isset($tempData->has_blocks) && $tempData->has_blocks) Blokta
                                @else
                                    Projede @endif Kaç Adet @if ($housingTypeTempX) {{ $housingTypeTempX->title }}
                                    @endif Var</h4><input
                                value="@if (isset($tempData->has_blocks) && $tempData->has_blocks) {{ isset($tempData->house_count0) ? $tempData->house_count0 : '' }} @else {{ isset($tempData->house_count) ? $tempData->house_count : '' }} @endif"
                                class="form-control mb-5 housing_count_input has_blocks-close @if (isset($tempData->has_blocks)) @if ($tempData->has_blocks) d-none @endif
@else
d-none @endif"
                                type="text" id="house_count" name="house_count"
                                placeholder="Kaç Adet Konutunuz Var" />

                            <span id="generate_tabs" style="width: 170px;justify-content: center"
                                class="d-flex btn btn-primary mb-5 has_blocks-close @if (isset($tempData->has_blocks)) @if ($tempData->has_blocks) d-none @endif
@else
d-none @endif">Daireleri
                                Oluştur</span>
                                    ...
                                    <div class="card">
                                        <div class="row px-5 py-4">
                                            <div class="col-md-4">
                                                ...
                                                <select onchange="changeData(this.value,'city_id')" name="city_id"
                                                    id="cities" class="form-control">
                                ...
                                <div class="row" style="align-items: center">
                                    <div class="col-md-12">
                                        <span class="doping-is-selected">
                                            @if (isset($tempDataFull) && isset($tempData) && isset($tempData->featured) && $tempData->featured) Seçildi
                                            @else
                                                Seçilmedi @endif
                                        </span>
                        ...
                        <div class="col-md-4">
                            <div class="doping-square @if (isset($tempDataFull) && isset($tempData) && isset($tempData->top_row) && $tempData->top_row) selected @endif" data-id="2">
                                <div class="row" style="align-items: center">
                                    <div class="col-md-12">
                                        <span class="doping-is-selected">
                                            @if (isset($tempDataFull) && isset($tempData) && isset($tempData->top_row) && $tempData->top_row) Seçildi
                                            @else
                                                Seçilmedi @endif
                                        </span>
                                        <img src="{{ URL::to('/') }}/images/emlaksepettelogo.png" alt="">
                    ...
                    <div class="row" style="justify-content:center;">
                        <div class="col-md-5">
                            <div class="finish-area">
                                ...
                                <div class="text"><a href="{{ route('institutional.projects.index') }}"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <ol>
                                    <li>
                                        <strong style="color:red" id="uniqueCodeRetry"></strong> kodunu EFT/Havale
                                        açıklama
                ...
                <div class="modal fade" id="rulesOpenModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <ol>
                                    <li> İlan yayıncısı EMLAKSEPETTE’de ilanlarını yayınlayarak “İlan Yayınlama Kuralları”nı
                                        kabul etmiş sayılır. Bu sebeple ilan yayınlayan her kişi ve kurum kurallara riayet
                                        etme mecburiyetindedir.</li>
                                    <li> İlan yayıncıları ilanın içeriğiyle ilgili bilgilerin doğruluğundan sorumludur. İlan
                                        bilgileri içerisindeki gerçek dışı fiyat, metrekare, açıklama, kat sayısı gibi
                                        parametreler sonucunda ilan, ilan sahibinde danışılmaksızın sistemden
                                        kaldırılabilir.</li>
                                    <li> İlan içerisinde yer alan fotoğrafların emlak ile ilişkili olması, ilanı yayınlayan
                                        kurumun ya da kişinin logo, tanıtım görseli vb.. olmaması gerekmektedir. Sistemde
                                        bulunan diğer ilanlardan ayrışmak maksadıyla ve haksız rekabet yaratmak amacıyla
                                        ilan resimlerinin üzerine herhangi bir yazı, ikon, şerit, çerçeve yerleştirilmesi
                                        fotoğrafın yayından kaldırılmasına sebep olabilir.</li>
                                    <li> İlan sahibi aynı gayrimenkulle ilgili sadece bir adet ilan yayınlayabilir. Aynı
                                        emlak ile ilgili girilecek çoklu kayıtlar mükerrer ilan sayılacaktır. Mükerrer
                                        ilanlar haksız rekabete yol açtığından ötürü sistemden ilan sahibine duyurmaksızın
                                        tamamen kaldırılabilir.</li>
                                    <li> İlan başlığı içerisinde yalnızca ilanda söz konusu olan gayrimenkule ait bilgiler
                                        verilebilir. İlan başlığı içerisinde iletişim bilgisi gibi haksız rekabete yol
                                        açabilecek bilgilerin yer verilmesi ilanın yayından kaldırılmasına sebep olabilir.
                                    </li>
                                    <li> İlan başlığı içerisinde Türkçe karakterler, Türk alfabesinde bulunmayan X, W, Q
                                        harfleri, rakamlar, nokta(.), virgül(,), ünlem(!) noktalama işaretleri
                                        kullanılabilir. Bu karakterlerin dışında kullanılacak alfanumerik olmayan, rekabete
                                        gölge düşürecek hiçbir karakterin ilanlarda yer almasına izin verilmeyecektir.</li>
                                    <li> İlan sahibi tarafından satılmış ya da kiralanmış gayrimenkullere ait ilanlar, ilan
                                        sahibi tarafından arşivlenmelidir. EMLAKSEPETTE sistemindeki operasyonu tamamlanmış
                                        ilanları belirli periyotlarla sistem haricine çıkarma hakkını saklı tutar. Bu işlem
                                        sonrasında doğacak yedekleme problemlerinden EMLAKSEPETTE sorumlu değildir.</li>
                                    <li> İlan bilgilerinin doluluğu ve doğruluğu, fotoğrafların kalitesi ve geçmiş
                                        hareketler göz önünde bulundurularak ilan sahiplerinin ilanları değerlendirilebilir.
                                        İlan yayınlama kurallarını sıklıkla ihlal eden kullanıcıların sözleşmesini tek
                                        taraflı olarak fesh etme hakkını EMLAKSEPETTE saklı tutar. Aynı şekilde ilan
                                        bilgilerini daimi olarak doğru ve hatasız giren kullanıcılar, haksız rekabete yol
                                        açmayacak şekilde sistem algoritması tarafından ödüllendirilerek ilanların öne
                                        çıkması sağlanabilir.</li>
                                    <li> İlan içerisinde yer alan ifadelerin cinsiyet, ırk, renk, dil, din, inanç, mezhep,
                                        felsefi ve siyasi görüş, etnik köken, servet, doğum, medeni hâl, sağlık durumu,
                                        engellilik ve yaş temellerine dayalı ayrımcılık niteliği taşımaması yasal bir
                                        zorunluluktur. Bu tür ifadeler kullanılması hukuka aykırı olup, Türkiye İnsan
                                        Hakları ve Eşitlik Kurumu (TİHEK) tarafından idari para cezası verilmesine sebep
                                        olabilir. Ayrıca, İlanda belirtilen ifadelerle ayrımcılığa yol açabilecek bilgilere
                                        yer verilmesi ilgili ifadelerin ve/veya ilanın yayından kaldırılması sebebidir.</li>
                                    <li> İlan yayınlama kurallarına riayet etmeyen kullanıcıların ilanlarındaki bilgilerinin
                                        bir kısmı ya da tamamının yayından kaldırılması hakkını EMLAKSEPETTE saklı tutar.
                                    </li>
                                    <li> Bireysel ve Kurumsal Hesap Sahibi, Portal üzerinden ilan verme, ilan düzenleme ve
                                        ilanı yeniden yayına alma işlemlerinden önce yasal mevzuat gereği sistem üzerinden
                                        kimliklerini doğrulamalıdır. Bireysel ve Kurumsal Hesap Sahibi, doğrulama işlemi
                                        yapmadıkları takdirde ilgili mevzuat uyarınca ilan veremeyeceklerini kabul eder.
                                    </li>
                                    <li> İlan başlığında ve ilan açıklama bölümünde sadece gayrimenkul hakkındaki bilgiler
                                        yer almalıdır.</li>
                                    <li> İlan başlığında ve ilan açıklama bölümlerde reklam içerikli yazı yazılmaması, link
                                        ve ürüne ait fotoğrafların eklenmemesi gerekmektedir.</li>
                                    <li> Yayınlanmak istenen ilanlarda kullanılan fotoğraflar, videolar ve 3 Boyutlu Tur
                                        görüntüsü, satılan/kiralanan gayrimenkule ait olmalıdır. Yayınlanan içerikler,
                                        fotoğraf, video veya link olarak ilana eklenen 3 Boyutlu Tur görüntüler hakkında
                                        EMLAKSEPETTE'nin herhangi bir sorumluluğu bulunmamaktadır.</li>
                                    <li> İlan girişlerinde belirtilen kriterlerde (metrekare, oda sayısı, bulunduğu kat,
                                        fiyat v.b.) doğru bilgiler yer almalıdır.</li>
                                    <li> Eklenen fotoğrafların, videoların, 3 Boyutlu Tur görüntülerinin içeriğinde firma
                                        logoları, telefon numarası veya farklı web sitelerinin link, logo ya da isimleri yer
                                        almamalıdır. Seçili vitrin resmi olarak işaretlenen görsellerde; firma logoları,
                                        telefon numarası, web sitelerinin linki, renkli arka plan, renkli çerçeve, metin
                                        içerikleri,firma isimleri, photoshop ve benzeri uygulamalarla eklentiler yer
                                        almamalıdır.</li>
                                    <li> Sistem içerisindeki farklı bir kullanıcının fotoğrafı / fotoğrafları
                                        kullanılmamalıdır.</li>
                                    <li> Bir gayrimenkulü satmak için ayrı, kiralamak için ayrı ilan verilmelidir. Aynı
                                        ilanda hem satılık hem kiralık detayları bulunamaz.</li>
                                    <li> Girilen bir ilanın aynısı, ilk girilen ilan silinerek sisteme yeniden girilemez.
                                        Bir ilanın silinip sisteme tekrar yeni baştan girilmesi ve benzeri nitelikteki
                                        faaliyetleri gerçekleştiren hesap sahiplerinin bu ilanları silinebilir, hesapları
                                        geçici olarak durdurulabilir veya iptal edilebilir.</li>
                                    <li> Aynı sitede veya blokta bulunan ve aynı özellikleri taşıyan gayrimenkuller için
                                        ayrı ilan girişi yapılmaması, tek bir ilan verilmesi ve bu ilanın açıklamasında aynı
                                        konumda farklı dairelerin de olduğunun belirtilmesi gerekmektedir. Aynı özellikte
                                        ikinci ilan girişi mükerrer (aynı kayıt) sayılmaktadır.</li>
                                    <li> Her bir ilan için farklı resimler kullanılmalıdır, aynı konumda dahi olsa aynı
                                        resim ikinci bir ilanda kullanılmamalıdır.</li>
                                    <li> Emlak ilan girişleri mutlaka mal sahibi tarafından veya mal sahibinin onayı
                                        alınarak yapılmalıdır. Bu sorumluluk ilan verene aittir. Mal sahibinin itirazı
                                        doğrultusunda hesap sahiplerinin bu ilanları silinebilir, hesapları geçici olarak
                                        durdurulabilir veya iptal edilebilir.</li>
                                    <li> Satılık veya kiralık gayrimenkuller için temsili fiyat verilmemelidir.</li>
                                    <li> İlan açıklama bölümlerinde web sayfası, mail adresi ve firma iletişim bilgilerine
                                        yer verilmemelidir. Telefon numarası ve kullanıcı adı sadece “Kullanıcı bilgileri”
                                        bölümünde yayınlanmalıdır. Mağaza kullanıcıları mağazaları için tanıtım sayfası
                                        hazırlayarak iletişim ve adres bilgilerini bu alanda yayınlayabilirler ancak web
                                        sayfası ve mail adreslerini belirtmemeleri gerekir</li>
                                    <li> Satılan ya da kiralanan ürünler Satıldı / Kiralandı olarak tekrar yayına verilemez.
                                        Satış işleminin devam ettiği izlenimi yaratan ya da tüketiciyi aldatma ve yanıltma
                                        ihtimali yaratabilecek “opsiyonlanmıştır', “kaporası alınmıştır”, "satılmıştır",
                                        "ilginiz için teşekkürler" gibi ya da bunlara benzer anlamda ibareler içeren ilanlar
                                        yayına alınmaz, yayında olan ilanlar yayından kaldırılır.</li>
                                    <li> İlan verme aşamasında, ilana ait belirlenmiş bazı kriterler için girilen bilgiler,
                                        ilan veren tarafından sonradan değiştirilemez, ilan veren bu konuda itirazda
                                        bulunmayacağını peşinen kabul etmektedir. EMLAKSEPETTE hangi kriterlere ait
                                        bilgilerin değiştirilemeyeceğini belirleme, zaman içinde belirlediği kriterlerde
                                        değişiklik yapma ve değişiklik yapma tarihi itibariyle belirlediği kriterleri tüm
                                        ilanlara uygulama hakkını saklı tutmaktadır.</li>
                                    <li> Günlük Kiralık İlan yayınlayanlar; 22/11/2016 tarihli Olağanüstü Hal Kapsamında
                                        Bazı Düzenlemeler Yapılması Hakkında Kanun Hükmünde Kararname ile getirilen yeni
                                        düzenlemelere, yasal mevzuata ve Portal'daki İlan Yayınlama Kurallarına uygun
                                        hareket etmekle yükümlüdür. Yasal yükümlülüklerini yerine getirmeden günlük kiralık
                                        ilan yayınlayanlar hakkında uygulanacak cezalardan münhasıran Günlük Kiralık İlan
                                        Veren sorumlu olacaktır.</li>
                                    <li> Turizm amaçlı kiralık ilan yayınlayanlar; “7464 sayılı “Konutların Turizm Amaçlı
                                        Kiralanmasına ve Bazı Kanunlarda Değişiklik Yapılmasına Dair Kanun” ile getirilen
                                        yeni düzenlemelere, yasal mevzuata ve Portal'daki İlan Yayınlama Kurallarına uygun
                                        hareket etmekle yükümlüdür. Yasal yükümlülüklerini yerine getirmeden turizm amaçlı
                                        kiralık ilan yayınlayanlar hakkında uygulanacak cezalardan münhasıran İlan Veren
                                        sorumlu olacaktır.</li>
                                    <li> Konut> Kiralık kategorisinde sadece aylık kiralık ilanlar verilebilir. Günlük,
                                        haftalık vb. kiralık ilanların Günlük Kiralık kategorisinden verilmesi
                                        gerekmektedir.</li>
                                    <li> Günlük kiralık dairelerde, fiyat kriterine günlük kiralama bedeli girilmelidir.
                                    </li>
                                    <li> İlanın işyeri ya da konut olarak değerlendirilmesinin kararı ilan verenin
                                        sorumluluğundadır. Seçilmiş kategori doğru olarak kabul edilir, ilan verme
                                        kurallarına aykırı bir durum yer almıyor ise ilan yayına alınır.</li>
                                    <li> Her farklı taşınmaz için ayrı ilan verilmelidir. Farklı konumdaki, taşınmazlar için
                                        toplu satış yapılamamaktadır.</li>
                                    <li> Turistik Tesis kategorisinde sadece turistik bir tesisin tamamı kiralanabilir ya da
                                        tamamının satışı yapılabilir.</li>
                                    <li> 13 Eylül 2018 tarihli "Türk Parasının Kıymetini Koruma hakkında 32 sayılı Kararda
                                        Değişiklik Yapılmasına Dair Karar"da, 6 Ekim 2018 tarihli “Türk Parası Kıymetini
                                        Koruma Hakkında 32 Sayılı Karara İlişkin Tebliğ”de ve 16 Kasım 2018 tarihli ve 30597
                                        sayılı Türk Parası Kıymetini Koruma Hakkında 32 Sayılı Karara İlişkin Tebliğ'de
                                        Değişiklik Yapılmasına Dair Tebliğ'de belirtilen sözleşme tiplerine dair
                                        kategorilerdeki ilanların fiyat bilgilerinin Türk Lirası olarak girilmesi
                                        gerekmektedir.</li>
                                    <li> Metaverse, OVR, sanal arazi, sanal dünya üzerinden arazi ve arsa satışları
                                        üzerinden arazi ve arsa satışlarına izin verilmez.</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                            ...
                            if (json[lm].type == "checkbox-group") {
                                ...
                                for (var t = 0; t < renderHtml.length; t++) {
                                    if (t != renderHtml.length - 1) {
                                        renderHtmlx += renderHtml[t] + (json[lm].name.split('[]')[0]) +
                                            i + '[]-' + i;
                                    } else {
                    ...
                    $('.item-left-area').click(function(e) {
                        ...
                        if (clickIndex > currentIndex) {
                            ...
                            $('.tab-pane.active input[type="file"]').map((key, item) => {
                                if ($(item).parent('div').find('.project_imaget')
                                    .length == 0) {
                                    nextHousing = false;
                                    $(item).addClass("error-border")
                                }
                    ...
                    $('.copy-item').change(function() {
                        ...
                        formData.append('new_order', (parseInt($('.house_order_input').val()) -
                            1));
                                    ...
                                    if (data[i].type == "select") {
                                        ...
                                        if (data[i].type != "file") {
                                            ...
                                            if (data[i][key[0]] == null) {
                                                ...
                                                if ($('.project_imaget img')
                                                    .length > 0) {
                                                    $('.project_imaget img').attr(
                                                        'src',
                    ...
                    $('.rendered-form input').change(function() {
                        if ($(this).attr('type') != "file") {
                            ...
                            formData.append('order', parseInt($('.house_order_input').val()) -
                                1);
                            formData.append('item_type', 1);
                            if ($(this).hasClass('only-one')) {
                                formData.append('only-one', "1");
                                $(this).closest('.form-group').find('.only-one[value!="' + $(
                    ...
                    $('.price-only').keyup(function() {
                        ...
                        if ($('.price-only').val().replace('.', '').replace('.', '').replace(
                                '.', '').replace('.', '') != parseInt($('.price-only').val()
                                .replace('.', '').replace('.', '').replace('.', '').replace('.',
                                    '').replace('.', ''))) {
                            if ($('.price-only').closest('.form-group').find('.error-text')
                                .length > 0) {
                                $('.price-only').val("");
                            } else {
                    ...
                    $('.cover-image-by-housing-type').change(function() {
                        ...
                        if (input.files && input.files[0]) {
                            ...
                            formData.append('order', (lastOrders + parseInt($(
                            ...
                            reader.onload = function(e) {
                                ...
                                $('.tab-pane.active .cover-image-by-housing-type').parent(
                    ...
                    $('#tablist').attr('style', 'height:' + $('.tab-content').css('height') +
                        ' !important;flex-wrap:nowrap;overflow:scroll;')
                },
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    for (let i = 1; i <= 1; i++) {
                                        ...
                                        renderedForm.formRender(formRenderOpts);
                                        var renderHtml = renderedForm.html().toString();
                                        renderHtml = renderHtml.toString().split(
                                            'images[][]');
                                        renderHtml = renderHtml[0];
                                        var json = JSON.parse(response.form_json);
                                        for (var lm = 0; lm < json.length; lm++) {
                                            if (json[lm].type == "checkbox-group") {
                                                var json = JSON.parse(response.form_json);
                                                var renderHtml = renderHtml.toString()
                                                    .split(json[lm].name + '-');
                                                renderHtmlx = "";
                                                for (var t = 0; t < renderHtml
                                                    .length; t++) {
                                                    if (t != renderHtml.length - 1) {
                                                        renderHtmlx += renderHtml[t] + (
                                    ...
                                    $('.add-new-project-house-image').click(function() {
                                        $(this).parent('div').find(
                                            '.new_file_on_drop').trigger(
                                            "click")
                                    })
                                    $('.second-payment-plan').closest('div').addClass(
                                        'd-none')
                                    $('.tab-pane select[multiple="false"]').removeAttr(
                                        'multiple')
                                    ...
                                    $('.item-left-area').click(function(e) {
                                        var clickIndex = $(this).index();
                                        var currentIndex = $('.nav-linkx.active')
                                            .closest('.item-left-area').index();
                                        ...
                                        if (clickIndex > currentIndex) {
                                            ...
                                            $('.tab-pane.active input[type="file"]')
                                                .map((key, item) => {
                                                    if ($(item).parent('div')
                                                        .find('.project_imaget')
                                                        .length == 0) {
                                            ...
                                            var indexItem = $('.tab-pane.active')
                                                .index();
                                            if (nextHousing) {
                                                $('.tab-pane.active').removeClass(
                                                    'active');
                                                $('.tab-pane').eq(indexItem + 1)
                                                    .addClass('active');
                                    ...
                                    $('.copy-item').change(function() {
                                        ...
                                        formData.append('last_order', (parseInt($(
                                            this).val()) - 1));
                                        console.log((lastOrders + parseInt($(
                                                '.house_order_input')
                                            .val()) - 1));
                                        formData.append('new_order', (parseInt(
                                            lastOrders) + parseInt($(
                                                '.house_order_input')
                                            .val()) - 1));
                                        formData.append('item_type', 1);
                                    ...
                                    $('.price-only').keyup(function() {
                                        $('.price-only .error-text').remove();
                                        if ($('.price-only').val().replace('.', '')
                                            .replace('.', '').replace('.', '')
                                            .replace('.', '') != parseInt($(
                                                    '.price-only').val().replace(
                                                    '.', '').replace('.', '')
                                                .replace('.', '').replace('.', '')
                                                .replace('.', ''))) {
                                            if ($('.price-only').closest(
                                                    '.form-group').find(
                                                    '.error-text').length > 0) {
                                                $('.price-only').val("");
                                            } else {
                    ...
                    if (response.status) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (data[i].type == "select") {
                                $('select[name="' + key[0] + '[]"]')
                                if (data[i][key[0]] == null) {
                                    $('select[name="' + key[0] + '[]"]').find('option').prop('selected',
                                        false);
                                } else {
                                ...
                                if (data[i].type != "file") {
                                    if (data[i].type == "checkbox-group") {
                                        if (data[i][key[0]] == null) {
                                            $('input[name="' + key[0] + '1[][]"]').prop("checked",
                                                false);
                                        } else {
                                    ...
                                    if (data[i][key[0]] == null) {
                                        ...
                                        if ($('.project_imaget img').length > 0) {
                                            $('.project_imaget img').attr('src',
                                                "{{ URL::to('/') }}/storage/project_images/" +
                                                data[i][key[0]])
                                        } else {
                                            $('.project_imaget').html(
                                                '<img src="{{ URL::to('/') }}/storage/project_images/' +
                                                data[i][key[0]] + '"/>')
                                        }
                                    }
                                }
        ...
        $(document).on('click', '.remove-block', function(e) {
            ...
            $.ajax({
                url: '{{ route('institutional.temp.order.remove.block.data') }}?item_type=' + 1 +
                    '&block_index=' + ($(this).closest('.block').index()) + '&is_active_block=' +
                    isActiveBlock,
                type: 'GET',
                success: function(response) {
                    response = JSON.parse(response);
                        ...
                        if (isActiveBlock) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                if (data[i].type == "select") {
                                    $('select[name="' + key[0] + '[]"]')
                                    if (data[i][key[0]] == null) {
                                        $('select[name="' + key[0] + '[]"]').find('option').prop(
                                            'selected', false);
                                    } else {
                                        $('select[name="' + key[0] + '[]"]').val(data[i][key[0]]);
                                    }
        ...
        $(document).on('click', '.prev-house-bottom', function(e) {
            if (!$(this).hasClass('disabled-button')) {
                ...
                $('html, body').animate({
                    scrollTop: $('.tab-pane.active').offset().top - parseFloat($('.navbar-top').css(
                        'height'))
                }, 100);
                $('.next-house-bottom').removeClass('disabled-button')
                var lastOrders = 0;
        ...
        $(window).scroll(function() {
            ...
            if ($(window).scrollTop() < (scrollTopValue + fullAreaHeight - 500) && $(window).scrollTop() > (
                    scrollTopValue - 500)) {
                $('.bottom-housing-area').removeClass('d-none')
            } else {
        ...
        var houseCount =
            @if (isset($tempData->has_blocks) && $tempData->has_blocks)
                {{ isset($tempData->house_count0) ? $tempData->house_count0 : 0 }}
            @else
                {{ isset($tempData->house_count) ? $tempData->house_count : 0 }}
            @endif ;
                ...
                if (houseType != 0) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                                    ...
                                    if (formInputs[j].type == "number" || formInputs[j].type ==
                                        ...
                                        $($('select[name="' + formInputs[j].name + '"]')[i - 1])
                                            .children('option').map((key, item) => {
                                                if (oldData[inputNamex[0]] != undefined) {
                                                    if ($(item).attr("value") == oldData[inputNamex[
                                                            0]][i - 1]) {
                                        ...
                                        $($('input[name="' + checkboxName + [i] + '[][]"]')).map((key,
                                            ...
                                            if (oldData[inputNamex[0] + (i)]) {
                                                oldData[inputNamex[0] + (i)].map((checkbox) => {
                                                    if (checkbox && $(item).attr(
                                                            "value")) {
                                                        if (checkbox.trim() == $(item)
                                                            .attr("value").trim()) {
                                                            $(item).attr('checked',
                                                                'checked')
                                                        }
                                        ...
                                        inputNamex = inputNamex.split('[]')
                                        if (oldData[inputNamex[0]] != undefined) {
                                            $($('input[name="' + formInputs[j].name + '"]')[i - 1])
                                                .parent('div').append(
                                                    '<div class="project_imaget"><img src="{{ URL::to('/') }}/storage/project_images/' +
                                                    oldData[inputNamex[0]][i - 1] + '"></div>');
                                        }
                                    }
                                }
                            }
                            ...
                            $('input[value="taksitli"]').change(function() {
                                if ($(this).is(':checked')) {
                                    $('.second-payment-plan').closest('div').removeClass(
                                        'd-none');
                                } else {
                                    $('.second-payment-plan').closest('div').addClass('d-none');
                                }
                            ...
                            $('.item-left-area').click(function(e) {
                                var clickIndex = $(this).index();
                                var currentIndex = $('.nav-linkx.active').closest(
                                    '.item-left-area').index();
                            ...
                            $('.copy-item').change(function() {
                                ...
                                formData.append('last_order', (parseInt($(this).val()) - 1));
                                formData.append('new_order', (lastOrders + parseInt($(
                                    '.house_order_input').val()) - 1));
                                formData.append('item_type', 1);
                            ...
                            $('.price-only').keyup(function() {
                                $('.price-only .error-text').remove();
                                if ($('.price-only').val().replace('.', '').replace('.', '')
                                    .replace('.', '').replace('.', '') != parseInt($(
                                        '.price-only').val().replace('.', '').replace('.',
                            ...
                            $('.cover-image-by-housing-type').change(function() {
                                ...
                                if (input.files && input.files[0]) {
                                    ...
                                    reader.onload = function(e) {
                                        ...
                                        $('.tab-pane.active .cover-image-by-housing-type')
                                            .parent('div').find('.project_imaget').remove()
                                        $('.tab-pane.active .cover-image-by-housing-type')
                                            .closest('.formbuilder-file').append(imageDiv)
                                        confirmHousings();
                                    };
        ...
        function confirmHousings() {
            ...
            if ($('.tab-pane').eq(0).find('input[type="file"]').closest('.formbuilder-file').find('.project_imaget img')
                .length == 0) {
                confirmCount += 1;
            } else {
                console.log("file");
            ...
            if (hasBlocks) {
                for (var i = 0; i < blockHouseCount.length; i++) {
                    for (var j = 0; j < blockHouseCount[i]; j++) {
                        htmlCopyItems += "<option value='" + (tempX) + "'>" + blockNames[i] + " Blok " + (j + 1) +
                            " Nolu Konut</option>";
                        tempX++;
                    }
                }
        ...
        $('.list-dates').click(function() {
            ...
            $.ajax({
                method: "GET",
                url: "{{ URL::to('/') }}/institutional/get_busy_housing_statuses/" + $(
                    '.doping_statuses').val(),
                data: {
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/ckeditor5/40.0.0/ckeditor.min.js"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="https://cdn.tiny.cloud/1/c2puh97n9lsir0u2h6xn3id7sk6y0tbhze4ahy5uwt0u4r9e/tinymce/6/tinymce.min.js"
        ...
        $('.finish-button').click(function(e) {
            ...
            if ($('.housing_after_step').hasClass('d-none')) {
                ...
                if (!$('input[name="name"]').val()) {
                    ...
                    topError = $('input[name="name"]').offset().top - parseFloat($('.navbar-top').css('height')) -
                        100;
                }
                ...
                if (descriptionText == "") {
                    next = false;
                    if (topError) {
                        if ($('.description-field').offset().top - parseFloat($('.navbar-top').css('height')) -
                            100 < topError) {
                    ...
                    if (!$(item).val() && $(item).attr('type') != 'file') {
                        ...
                        if (topError) {
                            if ($(item).offset().top - parseFloat($('.navbar-top').css('height')) - 100 <
                                topError) {
                                topError = $(item).offset().top - parseFloat($('.navbar-top').css(
                                    'height')) - 100;
                            }
                        } else {
                ...
                if ($('.photos .project_imagex').length == 0) {
                    ...
                    if (topError) {
                        if ($('.photo-area').offset().top - parseFloat($('.navbar-top').css('height')) - 100 <
                            topError) {
                            topError = $('.photo-area').offset().top - parseFloat($('.navbar-top').css('height')) -
                                100;
                        }
                    } else {
                ...
                if ($('.cover-document .has_file').length == 0) {
                    next = false;
                    if (topError) {
                        if ($('.cover-document-area').offset().top - parseFloat($('.navbar-top').css('height')) -
                            100 < topError) {
                    ...
                    if ($('.single-price-project-area .pricing-item .price-radio.select').length == 0) {
                        if (topError) {
                            if ($('.single-price-project-area').offset().top - parseFloat($('.navbar-top').css(
                                    'height')) - 100 < topError) {
                                topError = $('.single-price-project-area').offset().top - parseFloat($(
                                    '.navbar-top').css('height')) - 100;
                            }
                        } else {
        ...
        $('.area-list').eq(0).find('li').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    thisx.addClass('selected')
                    thisx.find('.loading-icon').remove();
                    $('.breadcrumb').append('<span class="breadcrumb-after-item">' + (thisx.html()) +
                        '</span>')
                    $('.breadcrumb-v2').append('<span class="breadcrumb-after-item">' + (thisx.html()) +
                        '</span>')
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('.breadcrumb-v2').append(
                                    '<span class="breadcrumb-after-item">' + (
                                        thisx.html()) + '</span>')
                                $('.last-housing-text').html('Önceki ' + (thisx
                                    .html()) + '')
                                $('.next-housing-text').html('Sonraki ' + (thisx
                                    .html()) + '')

                                $('.housings_title').html('Bu Projede Kaç Adet ' + (
                                    thisx.html()) + ' Var')
