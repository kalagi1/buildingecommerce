                ...
                <div class="table-responsive scrollbar mx-n1 px-1">
                    <table class="table fs--1 mb-0">
                        ...
                        <tr>
                            ...
                            <th class="sort" data-sort="discount_price">İndirimli Fiyat</th>
                            ...
                            <tr>
                                ...
                                <td class="sold">
                                    @if ($sold && $sold[0]->status == 1)
                                        <button class="btn btn-success">Satıldı</button>
                                    @elseif ($sold && $sold[0]->status == 0)
                                        <button class="btn btn-info">Ödeme Bekleniyor</button>
                                    @elseif ($sold && $sold[0]->status == 2)
                                        <button class="btn btn-warning">Tekrar Satışta</button>
                                    @else
                                        <button class="btn btn-danger">Satılmadı</button>
                                    @endif
                                </td>
                            </tr>
                        @endfor
