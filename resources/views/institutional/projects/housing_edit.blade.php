            ...
            <div class="second-area">
                <div class="row">
                    <div class="form-area mt-4">
                        <span class="section-title">{{$project->project_title}} Projesinde ki {{getData($project, 'advertise_title[]', $roomOrder) ?? getData($project, 'advertise_title[]', $roomOrder)->value}} Adlı Konutu Düzenle</span>
                        @if($errors->any())
