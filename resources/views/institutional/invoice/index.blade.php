                                            ...
                                            <tr>
                                                ...
                                                <td class="tm_width_5  tm_border_left" style="width: 100px">
                                                    @if ($data['project']['project_title'])
                                                        ...
                                                        <span style="font-size: 11px;font-weight:700;color:black">{{ $data['project']['city']['title'] . '/' . $data['project']['county']['ilce_title'] . '/' . $data['project']['neighbourhood']['mahalle_title'] }}</span>

                                                    @else
                                                        {{ $data['project']['title'] }} <br>
                                                        <span style="font-size: 11px;font-weight:700;color:black">{{ $data['project']['city']['title'] . '/' . $data['project']['county']['title'] . '/' . $data['project']['neighborhood']['mahalle_title'] }}</span>
                                                    @endif
                                                </td>
