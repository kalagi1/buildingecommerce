...
<div class="content">
    <h2 class="mb-2 lh-sm">Markalar</h2>
    <div class="mt-4">
      <div class="row g-4">
                  ...
                  <div class="d-flex align-items-center justify-content-end my-3">
                    <div id="bulk-select-replace-element">
                        <a class="btn btn-phoenix-success btn-sm" href="{{route('institutional.brands.create')}}">
                            ...
                            <span class="ms-1">Yeni Marka Ekle</span>
                        </a>
                    </div>
  ...
  @section('scripts')
    ...
    <script>
        ...
        brands.forEach(function(brand) {
            ...
            checkboxInput.setAttribute("data-bulk-select-row", JSON.stringify(brand));
            ...
            slugCell.innerHTML =  "<img style='max-width:100px;max-height:50px;' src='{{ asset('storage/brand_images/') }}/"+brand.logo+"'  />";

            var typeCell = document.createElement("td");
            typeCell.className = "align-middle cover_photo";
            typeCell.innerHTML =  "<img style='max-width:100px;max-height:50px;' src='{{ asset('storage/brand_images/') }}/"+brand.cover_photo+"'  />";


            var activeCell = document.createElement("td");
            activeCell.className = "align-middle status";
            activeCell.innerHTML = brand.status == 1 ? "<span class='btn btn-success'>Aktif</span>" : "<span class='btn btn-danger'>Pasif</span>";
            ...
            removeLink.setAttribute("data-brand-id", brand.id);
