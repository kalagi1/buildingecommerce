            ...
            <div class="col-auto">
                <div class="card-body position-relative">
                    <div class="badge badge-phoenix fs-10 badge-phoenix-warning mb-4"><span class="fw-bold">İlan No:
                            {{ $housing->id + 2000000 }}</span><svg class="svg-inline--fa fa-award ms-1"
                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="award" role="img"
                        ...
                        <div class="col-md-2 col-sm-3 col-4 mb-2">
                            <a href="{{ asset('housing_images/' . $image) }}" data-fancybox="gallery">
                                <img src="{{ asset('housing_images/' . $image) }}" class="img-fluid"
                                    alt="slider-listing" style="height: 100px; object-fit: cover; {{ $loop->first && isset($housingData->image) && $housingData->image == $image ? 'border: 3px solid green;' : '' }}">
                            </a>
                        </div>
                    @endforeach
                @endif
