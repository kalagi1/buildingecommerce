                                ...
                                @if ($coupons->count() > 0)
                                    @foreach ($coupons as $coupon)
                                        <tr>
                                            ...
                                            <td class="order_no">
                                                <a href="{{route('admin.estate.create.coupon',$user->id)}}" class="badge badge-phoenix badge-phoenix-primary">Satışları Listele</a>
                                                <a href="{{route('admin.estate.edit.coupon',$coupon->id)}}" class="badge badge-phoenix badge-phoenix-primary">Düzenle</a>
                                                <a href="{{route('admin.estate.coupon.destroy',$coupon->id)}}" class="badge badge-phoenix badge-phoenix-danger">Sil</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
