            ...
            <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white border-top border-bottom border-200 position-relative top-1">
                <div class="table-responsive scrollbar mx-n1 px-1">
                    <table class="table table-sm fs--1 mb-0">
                        <thead>
                            <tr>
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="refund_no">İade No</th>
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="refund_date">İade Tarihi</th>
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="refund_customer">İade Eden Alıcı</th>
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="refund_amount">Toplam Kapora</th>
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="refund_customer_amount">Alıcının İade Miktarı</th>
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="refund_admin_amount">Emlak Sepettenin Miktarı</th>
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="refund_status">İade Durumu</th>
                                <th class="sort white-space-nowrap align-middle pe-3" scope="col" data-sort="refund_detail">İade Detayı</th>
                            </tr>
                        </thead>
