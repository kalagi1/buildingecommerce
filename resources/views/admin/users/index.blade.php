                                    ...
                                    @foreach ($users as $key => $user)
                                        <tr class="position-static">
                                            ...
                                            <td>
                                                {{ $user->name }}
                                                @if ($user->type == 2)
                                                    <svg id="Layer_1" style="enable-background:new 0 0 120 120;"
                                                        version="1.1" width="24px" height="24px" viewBox="0 0 120 120"
                                            ...
                                            <td>
                                                <a href="{{ route('admin.user.show-corporate-account', ['user' => $user->id]) }}"
