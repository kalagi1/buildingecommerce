                        ...
                        <div class="card-body p-0">
                            <div class="p-4">
                                <form class="row g-3 needs-validation" novalidate="" method="POST"
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label" for="password">Şifre (Değiştirmek istemiyorsanız boş bırakın)</label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="type" class="form-select" id="validationCustom04" required="">
                                            <option value="1" {{ old('type', $user->type) == 1 ? 'selected' : '' }}>Normal Kullanıcı</option>
                                            <option value="2" {{ old('type', $user->type) == 2 ? 'selected' : '' }}>Kurumsal Üye</option>
                                        </select>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" name="is_active" id="flexSwitchCheckCheckedDisabled"
                                                type="checkbox" {{ old('is_active', $user->status) ? 'checked' : '' }} />
