...
@section('content')
<div class="content">
    <h2 class="mb-2 lh-sm">E-posta Şablonu Oluştur</h2>
    <div class="mt-4">
        <div class="row g-4">
                        ...
                        <div class="card-body p-0">
                            <div class="p-4">
                                ...
                                <form class="row g-3 needs-validation" id="emailTemplateForm" novalidate=""
                                    method="POST" action="{{ route('admin.email-templates.store') }}">
                                    @csrf
                                    <div class="col-md-12">
                                        <label class="form-label" for="name">Şablon Adı</label>
                                        <input name="name" class="form-control" id="name" type="text" value="" required>
                                        <div class="valid-feedback">İyi Görünüyor!</div>
                                    </div>

                                    <div class="col-md-12">
                                        <label class="form-label" for="subject">Konu</label>
                                        <input name="subject" class="form-control" id="subject" type="text" required>
                                    </div>
