        ...
        <div class="mb-9">
            <div id="emailTemplateList"
                ...
                <div class="row justify-content-between mb-4 gx-6 gy-3 align-items-center">
                    <div class="col-auto">
                        <h2 class="mb-0">E-posta Şablonları<span class="fw-normal text-700 ms-3">({{ count($templates) }})</span>
                        </h2>
                    </div>
                    <div class="col-auto">
                        <div class="col-auto"><a class="btn btn-primary px-5"
                                href="{{ route('admin.email-templates.create') }}"><i class="fa-solid fa-plus me-2"></i>Yeni
                                Ekle</a></div>
                    </div>
                </div>
                @if (session('success'))
