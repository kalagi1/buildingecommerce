                ...
                <div class="row justify-content-between mb-4 gx-6 gy-3 align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="col-auto"><a class="btn btn-primary px-5"
                                href="{{ route('admin.footer-sliders.create') }}"><i class="fa-solid fa-plus me-2"></i>Yeni
                                Ekle</a></div>
                    </div>
                </div>
                @if (session('success'))
                            ...
                            <tbody class="list" id="slider-list-table-body">
                                @foreach ($sliders as $slider)
                                    <tr class="position-static">
                                        ...
                                        <td>{{ $slider->title }}</td>
                                        <td>
                                            <a href="{{ route('admin.footer-sliders.edit', $slider->id) }}"
                                                class="btn btn-sm btn-primary">Düzenle</a>
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal{{ $slider->id }}">Sil</button>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="deleteModalLabel{{ $slider->id }}">Sil</h5>
                                                        ...
                                                        <div class="modal-footer">
                                                            <form
                                                                action="{{ route('admin.footer-sliders.destroy', $slider->id) }}"
