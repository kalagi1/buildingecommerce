                        ...
                        <div class="card-body p-0">
                            <div class="p-4">
                                ...
                                <form class="row g-3 needs-validation" id="emailTemplateForm" novalidate=""
                                    method="POST" enctype="multipart/form-data" action="{{ route('admin.bank_account.store') }}">
                                    @csrf
                                    <div class="col-md-12">
                                        <label class="form-label" for="name">Banka Resmi</label>
                                        <input name="image" class="form-control" type="file" value="" required>
                                        <div class="valid-feedback">İyi Görünüyor!</div>
                                    </div>

                                    <div class="col-md-12">
                                        <label class="form-label">Hesabın Alıcı Adı</label>
                                        <input name="recipient_full_name" class="form-control" type="text" required>
                                    </div>

                                    <div class="col-md-12">
                                        <label class="form-label">Iban</label>
                                        <input name="iban" class="form-control" type="text" required>
                                    </div>
