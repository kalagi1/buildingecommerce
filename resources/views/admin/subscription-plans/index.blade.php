        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="subscriptionPlans"
                    data-list='{"valueNames":["planName","planPrice","planProjectLimit","planUserLimit","planHousingLimit","action"],"page":12,"pagination":true}'>
                    <div class="row justify-content-between mb-4 gx-6 gy-3 align-items-center">
                        <div class="col-auto">
                            <h3 class="mb-0">Abonelik Planları<span
                                    class="fw-normal text-700 ms-3">({{ count($subscriptionPlans) }})</span>
                            </h2>
                        </div>
                        <div class="col-auto">
                            <a class="btn btn-primary px-5" href="{{ route('admin.subscriptionPlans.create') }}">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="planName">Plan Adı</th>
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="planPrice">Fiyat</th>
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="planProjectLimit">Proje Limiti</th>
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="planUserLimit">Alt Kullanıcı Limiti</th>
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            data-sort="planHousingLimit">Emlak Limiti</th>
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="deleteModalLabel{{ $plan->id }}">Sil</h5>
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('admin.subscriptionPlans.destroy', $plan->id) }}"
