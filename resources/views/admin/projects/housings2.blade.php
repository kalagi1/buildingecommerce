...
@section('content')
                ...
                @if ($project->have_blocks == 1)
                    ...
                    @foreach ($project->blocks as $key => $block)
                                        ...
                                        @for (; $i < $lastCountx + $block['housing_count']; $i++)
                                            ...
                                            <tr>
                                                ...
                                                <td class="sold">
                                                    ...
                                                    @endif
                                                    @if (isset(getData($project, 'off_sale[]', $i + 1)->value) &&
                                                            getData($project, 'off_sale[]', $i + 1)->value != '[]' &&
                                                            !$sold)
                                                        <div class="input d-none d-flex" style="align-items: center">
                                                ...
                                                @if ($sold && $sold[0]->status == 1 && $share_sale == '[]')
                                                    <td class="price">
                                                        ...
                                                        @if (!$share_sale)
                                                            <a href="#"
                                                                class="badge badge-phoenix badge-phoenix-info value-text"
                                        ...
                                        <div class="modal-body">
                                            <form
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="modal-input" id="tc"
                                                        name="tc" maxlength="11" value="{{ $cartOrder->tc }}">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="modal-input" id="address" rows="45" style="height: 100px !important;" name="address"
                                                        required>{{ $cartOrder->address }}</textarea>
                                                </div>
                        ...
                        @else
                            <td class="price">
                                @if (
                                    (isset($sumCartOrderQt[$i + 1]['qt_total']) && $sumCartOrderQt[$i + 1]['qt_total'] != $number_of_share) ||
                                        !isset($sumCartOrderQt[$i + 1]['qt_total']))
                                    <a type="button" class="badge badge-phoenix badge-phoenix-warning"
                                ...
                                @if (isset($share_sale) && $share_sale != '[]' && count($soldHisse) > 0)
                                    <button type="button" class="badge badge-phoenix badge-phoenix-success value-text"
                                        data-bs-toggle="modal" data-bs-target="#hisseliSatisModal{{ $j + 1 }}">
                                        Sipariş Detayları
                                    </button><br>

                                    <!-- Modal -->
                                    <div class="modal fade" id="hisseliSatisModal{{ $j + 1 }}" tabindex="-1"
                                        aria-labelledby="hisseliSatisModalLabel{{ $j + 1 }}" aria-hidden="true"
                                        data-bs-backdrop="static">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="hisseliSatisModalLabel{{ $j + 1 }}">
                                                        {{ $j + 1 }} Numaralı Hisse Sipariş Detay </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    @foreach ($soldHisse as $order)
                                                        ...
                                                        @if ($order->is_disabled == 1)
                                                            ...
                                                            <button type="button"
                                                                class="badge badge-phoenix badge-phoenix-warning value-text komsumuDuzenle"
                                                                data-order="{{ $order->id }}"
                                                                onclick="openNestedModal({{ $order->id }})">Komşumu
                                                                Düzenle</button>
                                                            ...
                                                            <div class="modal fade"
                                                                id="hisseliKomsuDuzenle{{ $order->id }}"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form
                                                                                ...
                                                                                <input type="hidden" name="projectID"
                                                                                    value="{{ $project->id }}">
                                                                                <input type="hidden" name="cartOrderID"
                                                                                    value="{{ $order->id }}">
                                                                                <input type="hidden"
                                                                                    name="cartOrderUserID"
                                                                                    value="{{ $order->user_id }}">

                                                                                <div class="form-group">
                                                                                    <label for="surname"
                                                                                        class="q-label">Email: </label>
                                                                                    <input type="text"
                                                                                        class="modal-input" id="email"
                                                                                        name="email"
                                                                                        value="{{ $order->email }}">
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="surname"
                                                                                        class="q-label">Ad Soyad: </label>
                                                                                    <input type="text"
                                                                                        class="modal-input" id="name"
                                                                                        name="name"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="surname"
                                                                                        class="q-label">TC : </label>
                                                                                    <input type="number"
                                                                                        class="modal-input" id="tc"
                                                                                        name="tc" maxlength="11"
                                                                                        value="{{ $order->tc }}">
                                                                                </div>

                                                                                <div class="form-group">
                                                                                    <label for="comment"
                                                                                        class="q-label">Adres:</label>
                                                                                    <textarea class="modal-input" id="address" rows="45" style="height: 100px !important;" name="address"
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="submit"
                                                                                        class="modal-btn-gonder">Gönder</button>
                                                                                    <button type="button"
                                                                                        class="modal-btn-kapat"
                                                                                        data-bs-dismiss="modal">Kapat</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                    ...
                    <div class="modal fade" id="exampleModal{{ $i + 1 }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center mx-auto" id="exampleModalLabel">
                                        {{ $project->project_title }} Projesinde {{ $block['block_name'] }}
                                        {{ $j + 1 }} Numaralı İlan
                                    </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                    ...
                                    <form action="{{ route('admin.projects.housings.komsumu.gor') }}" method="POST">
                                        ...
                                        <input type="hidden" name="projectID" value="{{ $project->id }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="modal-input" id="hisse_payi"
                                                    name="hisse_payi" min="0" max="{{ $number_of_share }}">
                                            </div>
                                        @endif
                                        <div class="form-group">
                                            <label for="surname" class="q-label">Email: </label>
                                        ...
                                        <div class="form-group">
                                            <label for="surname" class="q-label">TC : </label>
                                            <input type="number" class="modal-input" id="tc" name="tc"
                    ...
                    @for ($i = 0; $i < $project->room_count; $i++)
                        ...
                        <tr>
                            ...
                            <td class="price">
                                <div class="d-flex">
                                    <div class="input d-none d-flex" style="align-items: center">
                                        <input type="text" name="price[]" class="price-only" style="width: 120px;"
                                            value="{{ number_format(getData($project, 'price[]', $i + 1)->value, 0, ',', '.') }}">
                                        <span
                                            class="badge badge-phoenix badge-phoenix-success success-button-table mx-1 cursor-pointer d-flex"
                                            room-order="{{ $i + 1 }}"><i class="fa fa-check"></i></span>
                                        <span
                                            class="badge badge-phoenix badge-phoenix-danger cancel-button-table mx-1 cursor-pointer d-flex"><i
                                                class="fa fa-times"></i></span>
                                    </div>
                            ...
                            <td class="price">
                                @if (getData($project, 'installments-price[]', $i + 1) && getData($project, 'installments-price[]', $i + 1)->value)
                                    <div class="d-flex">
                                        <div class="input d-none d-flex" style="align-items: center">
                                            <input type="text" name="installments-price[]" class="price-only"
                                                style="width: 120px;"
                                                value="{{ number_format(getData($project, 'installments-price[]', $i + 1)->value, 0, ',', '.') }}">
                                            <span
                                                class="badge badge-phoenix badge-phoenix-success success-button-table mx-1 cursor-pointer d-flex"
                            ...
                            <td class="price">
                                @if (getData($project, 'installments[]', $i + 1))
                                    <div class="d-flex">
                                        <div class="input d-none d-flex" style="align-items: center">
                                            <input type="number" min="1" max="150" name="installments[]"
                                                class="number-only" style="width: 120px;"
                                                value="{{ getData($project, 'installments[]', $i + 1)->value }}">
                                            <span
                                                class="badge badge-phoenix badge-phoenix-success success-button-table mx-1 cursor-pointer d-flex"
                                                room-order="{{ $i + 1 }}"><i class="fa fa-check"></i></span>
        ...
        <div class="modal fade" id="exampleModal{{ $i + 1 }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.projects.housings.komsumu.gor.edit', ['id' => $i + 1]) }}"
                            method="POST">
                            @csrf
                            <input type="hidden" name="no" value="{{ $i + 1 }}">
                            <input type="hidden" name="projectID" value="{{ $project->id }}">
                            ...
                            <div class="form-group">
                                <label for="surname" class="q-label">TC :</label>
                                <input type="number" class="modal-input" id="tc" name="tc" maxlength="11"
                                    value="{{ $cartOrder->tc }}">
                            </div>
    ...
    @else
        <td class="price">
            ...
            @if (isset($share_sale) && $share_sale != '[]' && count($soldHisse) > 0)
                <button type="button" class="badge badge-phoenix badge-phoenix-success value-text"
                    data-bs-toggle="modal" data-bs-target="#hisseliSatisModal{{ $i + 1 }}">
                    Sipariş Detayları
                </button><br>

                <!-- Modal -->
                <div class="modal fade" id="hisseliSatisModal{{ $i + 1 }}" tabindex="-1"
                    aria-labelledby="hisseliSatisModalLabel{{ $i + 1 }}" aria-hidden="true"
                    data-bs-backdrop="static">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="hisseliSatisModalLabel{{ $i + 1 }}">
                                    {{ $i + 1 }} Numaralı Hisse Sipariş Detay </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                @foreach ($soldHisse as $order)
                                    ...
                                    <a href="{{ route('admin.invoice.show', ['order' => $order->id]) }}"
                                        class="badge badge-phoenix badge-phoenix-info value-text mb-2">
                                        {{ $order->id }} numaralı siparişin detayı - Hisse Payı {{ $qt }} /
                                        {{ $numberShare }}
                                    </a>
                                    @if ($order->is_disabled == 1)
                                        {{-- <button class="badge badge-phoenix badge-phoenix-warning value-text komsumuDuzenle" 
                                                                                data-order="{{$order->id}}" data-index="{{$i+1}}" data-bs-toggle="modal" data-bs-target="#hisseliKomsuDuzenle{{$order->id}}">
                                                                                    Komşumu Düzenle
                                                                                </button> --}}
                                        ...
                                        <button type="button"
                                            class="badge badge-phoenix badge-phoenix-warning value-text komsumuDuzenle"
                                            data-order="{{ $order->id }}"
                                            onclick="openNestedModal({{ $order->id }})">Komşumu Düzenle</button>
                                        <a href="{{ route('komsumu.sil', ['id' => $order->id]) }}"
                                            class="badge badge-phoenix badge-phoenix-danger value-text">
                                            Komşumu Sil
                                        </a>
                                        ...
                                        {{-- hisseli komşumu düzenleme --}}
                                        <div class="modal fade" id="hisseliKomsuDuzenle{{ $order->id }}"
                                            tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
        ...
        <div class="modal fade" id="exampleModal{{ $i + 1 }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-center mx-auto" id="exampleModalLabel">
                            {{ $project->project_title }} Projesinde  {{ $i + 1 }}
                            Numaralı İlan
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('admin.projects.housings.komsumu.gor') }}" method="POST">
                            ...
                            <input type="hidden" name="projectID" value="{{ $project->id }}">
                                ...
                                <div class="form-group">
                                    <label for="qt" class="q-label">Hisse Payı : </label>
                                    <input type="number" class="modal-input" id="hisse_payi" name="hisse_payi"
                                        min="0" max="{{ $number_of_share }}">
                                </div>
                            @endif
                            <div class="form-group">
                                <label for="surname" class="q-label">Email: </label>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('form').submit(function() {
                $('#spinner-overlay')
            .show(); // Form submit edildiğinde spinner overlay'ı görünür hale getir

                // Formun submit işlemini bekleyelim
                $(this).submit(function() {
                    $('#spinner-overlay')
                .hide(); // Form yanıtını aldıktan sonra spinner overlay'ı gizle
                });
            });
        });
        $(document).ready(function() {
            ...
            $('.email_search').on('input', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('.phone_komsumu_gor').val(response.phone ? response.phone :
                            ""); // Telefon alanını kontrol eder
                        $('.tc_komsumu_gor').val(response.tc ? response.tc :
                            ""); // TC alanını kontrol eder
                        $('.address_komsumu_gor').val(response.address ? response.address :
                            ""); // Adres alanını kontrol eder
                    },
                    error: function(xhr) {
                        console.log(xhr
                            .responseText); // Hata durumunda konsola hata mesajını yazdır
                    }
                });
            });
        });
    ...
    <script>
        $(document).ready(function() {
            var orderId = $('.komsumuDuzenle').data('order');
            console.log('#hisseliKomsuDuzenle' + orderId)


            // $(".komsumuDuzenle").click(function(){
            //     var orderId = $(this).data('order');
            //     var modalId = $(this).data('index');
            //     console.log('#hisseliKomsuDuzenle'+orderId)
            //     //$('#hisseliSatisModal'+modalId).modal('hide');

            //     // $('#hisseliKomsuDuzenle'+orderId).modal('show');
        ...
        function openNestedModal(orderId) {
            // İlgili iç içe geçmiş modalı açma kodunu buraya yazın
            $('#hisseliKomsuDuzenle' + orderId).modal('show');
            console.log('#hisseliKomsuDuzenle' + orderId)
        }
    </script>
