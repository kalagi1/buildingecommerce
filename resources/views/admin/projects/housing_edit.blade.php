            ...
            <div class="second-area">
                <div class="row">
                    <div class="form-area mt-4">
                        ...
                        @endif
                        <form action="{{route('admin.projects.edit.housing.post',["project_id" => $project->id, "room_order" => $roomOrder])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                    ...
                    success: function(response) {
                        ...
                        $('.copy-item').change(function() {
                            ...
                            for (var lm = 0; lm < json.length; lm++) {
                                if (json[lm].type == "checkbox-group") {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "{{ route('admin.temp.order.copy.checkbox') }}", // Sunucunuzun dosya yükleme işlemini karşılayan URL'sini buraya ekleyin
                                        data: formData,
                                        processData: false,
                                        contentType: false,
                                        success: function(response) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "{{ route('admin.temp.order.project.housing.change') }}", // Sunucunuzun dosya yükleme işlemini karşılayan URL'sini buraya ekleyin
                                        data: formData,
                                        processData: false,
                                        contentType: false,
                                        success: function(response) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "{{ route('admin.copy.item.image') }}", // Sunucunuzun dosya yükleme işlemini karşılayan URL'sini buraya ekleyin
                                        data: formData,
                                        processData: false,
                                        contentType: false,
                                        success: function(response) {
                        ...
                        $('.cover-image-by-housing-type').change(function() {
                            ...
                            if (input.files && input.files[0]) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "{{ route('admin.temp.order.project.add.image') }}", // Sunucunuzun dosya yükleme işlemini karşılayan URL'sini buraya ekleyin
                                    data: formData,
                                    processData: false,
                                    contentType: false,
                                    success: function(response) {},
                                    ...
                                    <div class="pay-desc-item">
                                        <div class="row" style="align-items: flex-end;">
                                            ...
                                            <div class="flex-10">
                                                ...
                                                <input type="date" name="pay-dec-date[]" value="${getOldData({{$roomOrder}}, "pay_desc_date{{$roomOrder}}0")}" class="form-control pay-desc-date">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        for(var i = 1; i < getOldData({{$roomOrder}}, "pay-dec-count{{$roomOrder}}"); i++){
                            $('.pay-desc').append(`
                                <div class="pay-desc-item">
                                    <div class="row" style="align-items: flex-end;">
                                        <div class="flex-1">
                                        ...
                                        <div class="flex-10">
                                            <label for="">Ara Ödeme Tarihi</label>
                                            <input type="date" name="pay-dec-date[]" value="${getOldData({{$roomOrder}}, "pay_desc_date{{$roomOrder}}"+i)}" class="form-control pay-desc-date">
                                        </div>
                                    </div>
                                </div>
                            `)
