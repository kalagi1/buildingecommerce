                    ...
                    @endif
                        ...
                        <div class="show-mobile">
                            <a
                                ...
                                <div class="mobile"> İLANI GÖR</div>
                            </a>
                            ...
                            <div class="tr-single-box">
                                ...
                                <div class="tr-single-body">
                                    <div class="tr-single-header pb-3">
                                        <h4><i class="fa fa-calendar"></i>Rezervasyon Detayları</h4>
                                    </div>
                                    <div class="booking-price-detail side-list no-border mb-3">
                                        <ul>
                                            <li>İlan: <strong class="pull-right">{{ $housing->housing_title }}
                                                </strong></li>
                                            <li>İlan No: <strong class="pull-right">{{ $housing->id + 2000000 }}
                                                </strong></li>
                                ...
                                <div class="tr-single-box">
                                    ...
                                    <div class="tr-single-body">
                                        ...
                                        <div class="booking-price-detail side-list no-border mb-3">
                                            @if (!$reservation)
                                                <ul>
                                                    <li>Toplam Tutar<strong class="pull-right">00.00
                                                            TL</strong></li>
                                                </ul>
                                            @else
                                                <ul>
                                                    ...
                                                    {{-- 
                                                        @if ($saleType == 'kiralik')
                                                            <li>Bir Kira Kapora :<strong
                                                                    class="pull-right ">{{ number_format($reservation->total_price, 0, ',', '.') }}
                                                                    TL</strong></li>
                                                        @else
                                                            <li> %{{ $discount_percent }} Kapora:<strong
                                                                    class="pull-right">{{ number_format($reservation->total_price * $deposit_rate, 0, ',', '.') }}
                                                                    TL</strong></li>
                                                        @endif --}}
