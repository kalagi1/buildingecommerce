              ...
              <TableBody>
                {rows.map((row) => (
                  ...
                  >
                    ...
                    <TableCell>
                      {row.room_count - row.cartOrders - row.offSale}
                    </TableCell>
                    <TableCell>
                      {row.status == 1 ? (
                    ...
                    <TableCell>
                      <a
                        href={`https://emlaksepette.com/institutional/projects/${row.id}/housings`}
                        class="badge badge-phoenix badge-phoenix-success"
                        onClick={setLoadingEditBTN(true)}
                      >
                        İlanları Düzenle
                      </a>
                      {loadingEditBTN ??  <div id="spinner">
                        <div
                    ...
                    <TableCell>
                      <a
                        ...
                        href={`https://emlaksepette.com/institutional/projects/${row.id}/logs`}
                      >
                        İşlem Kayıtları
                      </a>
                      <a
                        class="badge badge-phoenix badge-phoenix-success mx-3"
                        href={`https://emlaksepette.com/institutional/edit_project_v2/${row.slug}/${row.id}`}
                      >
                        Genel Düzenleme
                      </a>
                    </TableCell>
