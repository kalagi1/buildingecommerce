    ...
    <div className="estate-table">
      ...
      >
        <ul className="popover-project-actions p-relative">
          ...
          <li className="d-flex"><a href={`http://127.0.0.1:8000/hesabim/projects/${selectedRow?.id}/logs`}>İşlem Kayıtları</a></li>
          <li className="d-flex"><a href={`http://127.0.0.1:8000/hesabim/edit_project_v2/${selectedRow?.slug}/${selectedRow?.id}`}>Genel Düzenleme</a></li>
