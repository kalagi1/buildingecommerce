                                    ...
                                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                        ...
                                        {rows.map((row) => (
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <a href={`https://test.emlaksepette.com/institutional/projects/${row.id}/housings_v2`} class="badge badge-phoenix badge-phoenix-success">İlanları Düzenle</a>
                                                </TableCell>
                                                <TableCell>
                                                    <div className="d-flex">
                                                        <a class="badge badge-phoenix badge-phoenix-warning" href={`https://test.emlaksepette.com/institutional/projects/${row.id}/logs`}>İşlem Kayıtları</a>
                                                        <a class="badge badge-phoenix badge-phoenix-success mx-3" href={`https://test.emlaksepette.com/institutional/edit_project_v2/${row.slug}/${row.id}`}>Genel Düzenleme</a>
                                                    </div>
                                                </TableCell>
                                                <TableCell>
                                                    <div className="d-flex">
