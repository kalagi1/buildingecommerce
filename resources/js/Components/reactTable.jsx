                ...
                <TableBody>
                  {rows.map((row) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <a
                          href={`https://hisselitask.emlaksepette.com/hesabim/projects/${row.id}/housings_v2`}
                      ...
                      <TableCell>
                        <div className="d-flex">
                          <a
                            ...
                            href={`https://hisselitask.emlaksepette.com/hesabim/projects/${row.id}/logs`}
                          >
                            İşlem Kayıtları
                          </a>
                          <a
                            class="badge badge-phoenix badge-phoenix-success mx-3"
                            href={`https://hisselitask.emlaksepette.com/hesabim/edit_project_v2/${row.slug}/${row.id}`}
                          >
                            Genel Düzenleme
                          </a>
                        </div>
