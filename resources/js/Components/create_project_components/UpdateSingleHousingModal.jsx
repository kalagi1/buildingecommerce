...
function UpdateSingleHousingModal({saveHousing,saveSingleHousing,open,setOpen,data,setData,selectedType,isDotType}) {
    const style = {
        position: 'absolute',
        top: '50%',
        left: '50%',
...
export default UpdateSingleHousingModal