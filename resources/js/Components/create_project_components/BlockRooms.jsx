...
function BlockRooms({slug,selectedTypes,formDataHousing,anotherBlockErrors,selectedBlock,setSelectedBlock,selectedRoom,setSelectedRoom,blocks,setBlocks,roomCount,setRoomCount,selectedHousingType,allErrors}) {
                                ...
                                if(slug == "satilik" && !data?.className?.includes("only-show-project-rent") && !data?.className?.includes("only-show-project-daliy-rent")){
                                    if(!data?.className?.includes("project-disabled")){
                                        ...
                                        if(data?.className?.includes('--if-show-checked-')){
                                            console.log(data?.className?.split('--if-show-checked-')[1],selectedRoom,data?.className?.split('--if-show-checked-')[1]);
                                            isX = !checkedItems.find((checkedItem) => {return checkedItem.roomOrder == selectedRoom && checkedItem.name == data?.className?.split('--if-show-checked-')[1];})
                                        }
                                            ...
                                            if(data.type == "text"){
                                                        ...
                                                        </label>
                                                        {
                                                            ...
                                                            : 
                                                                data?.className?.includes('tel-only') ?
                                                                    <input id={data?.name.replace('[]','')} type='text' value={blocks[selectedBlock]?.rooms[selectedRoom] && blocks[selectedBlock]?.rooms[selectedRoom][data.name] ? blocks[selectedBlock]?.rooms[selectedRoom][data.name] : ''} onChange={(e) => {blockDataSet(selectedBlock,data?.name,telNumberFormat(e.target.value))}} className={'form-control '+(validationErrors.includes(data?.name) ? "error-border" : "")+' '+(allErrors.includes(data?.name.replace('[]','')) ? "error-border" : "")}/>
                                                                :
                                                ...
                                                return(
                                                    <div className={"form-group "+(isX ? "d-none" : "")}>
                                                        ...
                                                        <input id={data?.name.replace('[]','')} type='date' value={blocks[selectedBlock]?.rooms[selectedRoom] && blocks[selectedBlock]?.rooms[selectedRoom][data.name] ? blocks[selectedBlock]?.rooms[selectedRoom][data.name] : ''} onChange={(e) => {if(e.target.value.length == 10){blockDataSet(selectedBlock,data?.name,e.target.value)}}} className={'form-control '+(validationErrors.includes(data?.name) ? "error-border" : "")+' '+(allErrors.includes(data?.name.replace('[]','')) ? "error-border" : "")}/>
                                                    </div>
                                                )
                                            ...
                                            if(data.type == "text"){
                                                ...
                                                return(
                                                    <div className={"form-group "+(isX ? "d-none" : "")}>
                                                        ...
                                                        <input id={data?.name.replace('[]','')} type='date' value={blocks[selectedBlock]?.rooms[selectedRoom] && blocks[selectedBlock]?.rooms[selectedRoom][data.name] ? blocks[selectedBlock]?.rooms[selectedRoom][data.name] : ''} onChange={(e) => {if(e.target.value.length){blockDataSet(selectedBlock,data?.name,e.target.value)}}} className={'form-control '+(validationErrors.includes(data?.name) ? "error-border" : "")+' '+(allErrors.includes(data?.name.replace('[]','')) ? "error-border" : "")}/>
                                                    </div>
                                                )
                                            }else if(data.type == "select"){
                                                return(
