                                                ...
                                                if(data.subtype == "time"){
                                                    return(
                                                        <div className={"form-group "+(isX ? "d-none" : "")}>
                                                            ...
                                                            <input id={data?.name.replace('[]','')} type='time' value={blocks[selectedBlock]?.rooms[selectedRoom] && blocks[selectedBlock]?.rooms[selectedRoom][data.name] ? blocks[selectedBlock]?.rooms[selectedRoom][data.name] : ''} onChange={(e) => {if(e.target.value.length == 10){blockDataSet(selectedBlock,data?.name,e.target.value)}}} className={'form-control '+(validationErrors.includes(data?.name) ? "error-border" : "")+' '+(allErrors.includes(data?.name.replace('[]','')) ? "error-border" : "")}/>
                                                        </div>
                                                    )
                                                }else{
                                                    return(
