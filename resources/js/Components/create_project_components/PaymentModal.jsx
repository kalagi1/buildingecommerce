...
function PaymentModal({
  ...
  const save = () => {
    setSaveLoading(true);
    axios
      .post(baseUrl + "save_installments/" + projectId + "/" + selectedId, {
        installments: installments,
      })
      .then((res) => {
        console.log("save_installments" + res.data.data);
        if (res.data.status) {
          // Backend'in başarılı yanıt verdiğinden emin olun
    ...
    axios
      .post(baseUrl + "save_sale/" + projectId, {
        ...data,
  ...
  useEffect(() => {
    if (open && selectedId) {
      ...
      axios
        .get(baseUrl + "get_installments/" + projectId + "/" + selectedId)
        .then((res) => {
  ...
  var installmentCount =
    selectedData && selectedData["installments[]"]
      ? parseInt(selectedData["installments[]"])
      : 0;
  ...
  const getInstallmentMonthPrice = () => {
    var priceNotPayDecs =
      parseInt(selectedData["installments-price[]"]) -
      parseInt(selectedData["advance[]"]);
    var payDecPrice = 0;
    for (var i = 0; i < selectedData["pay-dec-count" + selectedId]; i++) {
      payDecPrice += parseInt(
        selectedData["pay_desc_price" + selectedId + i].replace(".", "")
      );
    }
              ...
              <Grid container spacing={3} direction="row">
                <Grid item xs={6} md={6}>
                  <FormControl fullWidth margin="normal">
                    <InputLabel id="attributes-label">
                      Satın Alma Türü
                    </InputLabel>
                    <Select
                  ...
                  control={
                    <Switch
                      onChange={() => {
                        setData({
                          ...data,
                          show_neighbour: !data.show_neighbour,
                        });
                      }}
                      checked={data.show_neighbour}
                    />
                  }
                  label="Açık"
                />
                ...
                <FormControl fullWidth margin="normal">
                  <div className="dec-pay-area">
                    <div className="top">
                      ...
                      <button
                        onClick={addPayDec}
                        className="btn btn-primary add-pay-dec"
                      >
                        <svg
                            ...
                            >
                              <div className="flex-1">
                                <button
                                  ...
                                  className="btn btn-primary remove-pay-dec"
                                >
                                  <svg
                              ...
                              <div className="flex-10">
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    setPayDecPrice(i, e.target.value);
                                  }}
                                  value={dotNumberFormat(payDec.price)}
                                />
                              </div>
                              <div className="flex-10">
                                ...
                                <input
                                  ...
                                  className="form-control"
                                  onChange={(e) => {
                                    setPayDecDate(i, e.target.value);
                                  }}
                                  value={payDec.date}
                                />
                              </div>
                              <div style={{ flex: "2" }}>
                                {payDec.status ? (
                                  <div
                                    onClick={() => {
                                      setPayDecStatus(i, false);
                                    }}
                                    className="add-button-payment mx-2"
                                  ...
                                  <div
                                    onClick={() => {
                                      setPayDecStatus(i, true);
                                    }}
                                    className="confirm-button-payment mx-2"
                                    style={{ cursor: "pointer" }}
                                  >
              ...
              {startDateConfirm ? (
                      ...
                      >
                        ...
                        <div className="col-md-2">
                          ...
                          <input
                            type="text"
                            onChange={(e) => {
                              setPaymentPrice(i, e.target.value, "price");
                            }}
                            value={dotNumberFormat(installment.price)}
                            className="form-control"
                          />
                        </div>
                        <div className="col-md-2">
                          ...
                          <input
                            type="date"
                            onChange={(e) => {
                              setPaymentDate(i, e.target.value);
                            }}
                        ...
                        <div className="col-md-2">
                          ...
                          <input
                            type="date"
                            onChange={(e) => {
                              setPaymentPaymentDate(i, e.target.value);
                            }}
                        ...
                        <div className="col-md-2">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setPaymentMethod(i, e.target.value);
                            }}
                            className="form-control"
                            id=""
                          >
                        ...
                        <div className="col-md-2">
                          ...
                          <input
                            type="text"
                            onChange={(e) => {
                              setPaymentPrice(i, e.target.value, "desc");
                            }}
                ...
                <div>
                  <div className="alert alert-danger mt-3">
                    Taksit başlangıç tarihi girilmeden taksitleri
                    listeleyemezsiniz
                  </div>
                </div>
              )}
