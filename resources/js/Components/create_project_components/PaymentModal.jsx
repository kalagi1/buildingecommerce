                                            ...
                                            <div>
                                                <div className="payment-modal-section d-flex">
                                                    ...
                                                    </button>
                                                    {
                                                        isManager ? 
                                                            <>
                                                                <button onClick={lockedFunc} className='all_selected_button ml-2' style={{background:(locked ? "#EA2B2E" : "#fff"),color:(locked ? "#fff" : "#EA2B2E")}} > 
                                                                    <i className='fas fa-user-lock mx-2'></i> 
                                                                    <span>{locked ? "Kilitlendi" : "Kilitle"}</span> 
                                                                </button>
                                                                <button onClick={() => {openLockersFunc()}} className='all_selected_button ml-2' style={{borderColor:(locked ? "gray" : "#EA2B2E"),color:(locked ? "gray" : "#EA2B2E")}} > 
