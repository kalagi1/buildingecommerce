                                            ...
                                            <div>
                                                <div className="payment-modal-section d-flex">
                                                    ...
                                                    </button>
                                                    {
                                                        isManager ? 
                                                            <>
                                                                <button onClick={lockedFunc} className='all_selected_button ml-2' style={{background:(locked ? "#D32729" : "#fff"),color:(locked ? "#fff" : "#D32729")}} > 
                                                                    <i className='fas fa-user-lock mx-2'></i> 
                                                                    <span>{locked ? "Kilitlendi" : "Kilitle"}</span> 
                                                                </button>
                                                                <button onClick={() => {openLockersFunc()}} className='all_selected_button ml-2' style={{borderColor:(locked ? "gray" : "#D32729"),color:(locked ? "gray" : "#D32729")}} > 
