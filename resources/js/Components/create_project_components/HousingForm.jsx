...
function HousingForm({
    ...
    const setGeolocation = (cityId, countyId = null, neighborhoodId = null) => {
        ...
        fromAddress(
            `${cityTemp.title} ${countyTemp?.ilce_title || ""} ${neighborhoodTemp?.mahalle_title || ""
            }`
        )
            .then(({ results }) => {
    ...
    useEffect(() => {
        ...
        const handleClick = (e) => {
          if (isShowRef.current && bounds && bounds.contains(e.latLng)) {
            const lat = e.latLng.lat();
            const lng = e.latLng.lng();
            setSelectedLocation({ lat, lng });
          } else {
            alert("Lütfen il, ilçe ve mahalle seçimini tamamlayınız veya geçerli bir konum seçiniz.");
          }
        };
                        ...
                        <div className="row" style={{ alignItems: "center" }}>
                            <div className="input col-md-10">
                                <input
                                    ...
                                    type="text"
                                    className={`form-control advert_title ${allErrors.includes("project_title") ? "error-border" : ""
                                        }`}
                                />
                            </div>
                ...
                <div className="row">
                    <div className="col-md-4">
                        ...
                        <select
                            ...
                            name="city_id"
                            id="city_id"
                            className={`form-control ${allErrors.includes("city_id") ? "error-border" : ""
                                }`}
                        >
                    ...
                    <div className="col-md-4">
                        ...
                        <select
                            ...
                            name="county_id"
                            id="county_id"
                            className={`form-control ${allErrors.includes("county_id") ? "error-border" : ""
                                }`}
                        >
                    ...
                    <div className="col-md-4">
                        ...
                        <select
                            ...
                            id="neighbourhood_id"
                            className={`form-control ${allErrors.includes("neighborhood_id") ? "error-border" : ""
                                }`}
                        >
